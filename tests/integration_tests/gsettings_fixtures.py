...
def _inject_generated_module_stubs() -> None:
    ...
    i18n = types.ModuleType("blind_x.blind_x_i18n")
    ...
    sys.modules["blind_x.blind_x_i18n"] = i18n

    platform = types.ModuleType("blind_x.orca_platform")
...
def _build_schemas(source_root: str, output_dir: str) -> None:
    ...
    schema_xml = os.path.join(output_dir, "org.gnome.BlindX.gschema.xml")
...
def _gsettings_registry() -> Generator:
    ...
    schema_dir = tempfile.mkdtemp(prefix="blind-x-test-schemas-")
    ...
    from blind_x.gsettings_registry import get_registry  # pylint: disable=import-outside-toplevel
