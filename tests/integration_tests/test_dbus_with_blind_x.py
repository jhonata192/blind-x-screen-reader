...
"""Integration tests for Blind-X's D-Bus service."""
...
def is_context_error(error_str: str) -> bool:
    ...
    This function checks for common error patterns that indicate the Blind-X
...
class TestOrcaDBusIntegration:
    """Integration tests for Blind-X D-Bus service using pytest features."""

    @pytest.mark.dbus
    def test_orca_dbus_service_running(self, dbus_service_proxy):
        """Test that Blind-X D-Bus service is running and accessible."""
