...
class TestAXUtilitiesRole:
    ...
    def _setup_dependencies(self, test_context: OrcaTestContext) -> dict[str, MagicMock]:
        ...
        object_props_mock = essential_modules["blind_x.object_properties"]
    ...
    def test_simple_role_methods(self, test_context, case: dict) -> None:
        ...
        mock_ax_object_class = essential_modules["blind_x.ax_object"].AXObject
    ...
    def test_is_editable_combo_box(self, test_context: OrcaTestContext) -> None:
        ...
        mock_utilities_state_class = essential_modules["blind_x.ax_utilities_state"].AXUtilitiesState
    ...
    def test_is_button_with_popup(self, test_context: OrcaTestContext, case: dict) -> None:
        ...
        ax_utilities_state_mock = essential_modules["blind_x.ax_utilities_state"].AXUtilitiesState
        from blind_x.ax_utilities_role import AXUtilitiesRole
    ...
    def test_get_display_style(self, test_context: OrcaTestContext) -> None:
        ...
        self._setup_dependencies(test_context)
        from blind_x import ax_utilities_role
        from blind_x.ax_utilities_role import AXUtilitiesRole
