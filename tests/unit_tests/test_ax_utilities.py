...
class TestAXUtilities:
    ...
    def _setup_dependencies(self, test_context: OrcaTestContext) -> dict[str, MagicMock]:
        ...
        additional_modules = [
            "blind_x.ax_action",
            "blind_x.ax_component",
            "blind_x.ax_selection",
            "blind_x.ax_utilities_action",
            "blind_x.ax_utilities_component",
            "blind_x.ax_utilities_object",
            "blind_x.ax_table",
            "blind_x.ax_text",
            "blind_x.ax_utilities_application",
            "blind_x.ax_utilities_collection",
            "blind_x.ax_utilities_event",
            "blind_x.ax_utilities_relation",
            "blind_x.ax_utilities_role",
            "blind_x.ax_utilities_selection",
            "blind_x.ax_utilities_state",
            "blind_x.ax_utilities_table",
        ]
        ...
        essential_modules["blind_x.ax_object"].AXObject = ax_object_class_mock
        ...
        essential_modules["blind_x.ax_utilities_role"].AXUtilitiesRole = role_class_mock
        ...
        essential_modules["blind_x.ax_utilities_state"].AXUtilitiesState = state_class_mock
        ...
        essential_modules["blind_x.ax_utilities_relation"].AXUtilitiesRelation = relation_class_mock
        ...
        essential_modules["blind_x.ax_utilities_application"].AXUtilitiesApplication = app_class_mock
        ...
        essential_modules["blind_x.ax_table"].AXTable = table_class_mock
        ...
        essential_modules["blind_x.ax_utilities_table"].AXUtilitiesTable = utilities_table_class_mock
        ...
        essential_modules["blind_x.ax_text"].AXText = text_class_mock
    ...
    def test_has_explicit_name_true(self, test_context: OrcaTestContext) -> None:
        ...
        essential_modules["blind_x.ax_object"].AXObject.get_attribute = test_context.Mock(
            return_value="true",
        )
        from blind_x.ax_utilities import AXUtilities
    ...
    def test_is_redundant_object_different_names(self, test_context: OrcaTestContext) -> None:
        ...
        essential_modules["blind_x.ax_object"].AXObject.get_name = mock_get_name
        essential_modules["blind_x.ax_object"].AXObject.get_role = test_context.Mock(
    ...
    def test_is_redundant_object_same_name_and_role(self, test_context: OrcaTestContext) -> None:
        ...
        essential_modules: dict[str, MagicMock] = self._setup_dependencies(test_context)
        essential_modules["blind_x.ax_object"].AXObject.get_name = test_context.Mock(
            return_value="Button",
        )
        essential_modules["blind_x.ax_object"].AXObject.get_role = test_context.Mock(
            return_value=Atspi.Role.BUTTON,
    ...
    def test_is_layout_only_scenarios(  # pylint: disable=too-many-branches,too-many-statements
        ...
        for mock_path, mock_value in mocks_config.items():
            if mock_path == "has_explicit_name":
                test_context.patch(
                    "blind_x.ax_utilities.AXUtilities.has_explicit_name",
                    return_value=mock_value,
                )
            elif mock_path == "_is_layout_only":
                test_context.patch(
                    "blind_x.ax_utilities.AXUtilities._is_layout_only",
                    return_value=mock_value,
                )
                ...
                setattr(
                    essential_modules["blind_x.ax_utilities_role"].AXUtilitiesRole,
                    method_name,
                ...
                method_name = mock_path.split(".", 1)[1]
                setattr(
                    essential_modules["blind_x.ax_utilities_state"].AXUtilitiesState,
                    method_name,
                    test_context.Mock(return_value=mock_value),
                )
                ...
                method_name = mock_path.split(".", 1)[1]
                setattr(
                    essential_modules["blind_x.ax_table"].AXTable,
                    method_name,
                    test_context.Mock(return_value=mock_value),
                )
                ...
                method_name = mock_path.split(".", 1)[1]
                setattr(
                    essential_modules["blind_x.ax_utilities_table"].AXUtilitiesTable,
                    method_name,
                    test_context.Mock(return_value=mock_value),
                )
    ...
    def test_sort_by_child_index_needs_sorting(self, test_context: OrcaTestContext) -> None:
        ...
        essential_modules: dict[str, MagicMock] = self._setup_dependencies(test_context)
        essential_modules["blind_x.ax_object"].AXObject.get_index_in_parent = mock_get_index
        from blind_x.ax_utilities import AXUtilities
    ...
    def test_treat_as_leaf_node_with_child_count(self, test_context: OrcaTestContext) -> None:
        ...
        essential_modules: dict[str, MagicMock] = self._setup_dependencies(test_context)
        essential_modules["blind_x.ax_object"].AXObject.get_child_count = test_context.Mock(
            return_value=3,
        )
        from blind_x.ax_utilities import AXUtilities
    ...
    def test_treat_as_leaf_node_without_children(self, test_context: OrcaTestContext) -> None:
        ...
        essential_modules["blind_x.ax_utilities_role"].AXUtilitiesRole.is_page_tab = test_context.Mock(
            return_value=False,
        )
        from blind_x.ax_utilities import AXUtilities
    ...
    def test_has_visible_caption_without_label(self, test_context: OrcaTestContext) -> None:
        ...
        essential_modules: dict[str, MagicMock] = self._setup_dependencies(test_context)
        essential_modules["blind_x.ax_utilities_role"].AXUtilitiesRole.is_label = test_context.Mock(
            return_value=False,
        )
        from blind_x.ax_utilities import AXUtilities
    ...
    def test_get_heading_level_with_level(self, test_context: OrcaTestContext) -> None:
        ...
        essential_modules: dict[str, MagicMock] = self._setup_dependencies(test_context)
        essential_modules["blind_x.ax_utilities_role"].AXUtilitiesRole.is_heading = test_context.Mock(
            return_value=True,
        )
        essential_modules["blind_x.ax_object"].AXObject.get_attributes_dict = test_context.Mock(
    ...
    def test_is_message_dialog_scenarios(  # pylint: disable=too-many-branches,too-many-positional-arguments
        ...
        if supports_collection is not None:
            essential_modules["blind_x.ax_object"].AXObject.supports_collection = test_context.Mock(
                return_value=supports_collection,
            )

        if not supports_collection and get_all_widgets is not None:
            test_context.patch(
                "blind_x.ax_utilities.AXUtilities.get_all_widgets",
        ...
        for check_name, check_value in collection_checks.items():
            if check_name in ["has_scroll_pane", "has_split_pane"]:
                setattr(
                    essential_modules["blind_x.ax_utilities_collection"].AXUtilitiesCollection,
                    check_name,
                    test_context.Mock(return_value=check_value),
                )
            else:
                setattr(
                    sys.modules["blind_x.ax_utilities_collection"].AXUtilitiesCollection,
                    check_name,
                    test_context.Mock(return_value=check_value),
                )
    ...
    def test_can_be_active_window_with_dialog(self, test_context: OrcaTestContext) -> None:
        ...
        essential_modules: dict[str, MagicMock] = self._setup_dependencies(test_context)
        essential_modules["blind_x.ax_utilities_state"].AXUtilitiesState.is_active = test_context.Mock(
            return_value=True,
        )
        essential_modules[
            "blind_x.ax_utilities_state"
    ...
    def test_get_unfocused_alerts_and_dialogs_with_alerts(
        ...
        essential_modules["blind_x.ax_object"].AXObject.iter_children = mock_iter_children
        from blind_x.ax_utilities import AXUtilities
    ...
    def test_get_all_widgets_exclude_push_button(self, test_context: OrcaTestContext) -> None:
        ...
        collection_module = sys.modules["blind_x.ax_utilities_collection"]
    ...
    def test_find_active_window_with_active_window(self, test_context: OrcaTestContext) -> None:
        ...
        essential_modules["blind_x.ax_object"].AXObject.iter_children = test_context.Mock(
    ...
    def test_get_on_screen_objects_with_invalid_root(self, test_context: OrcaTestContext) -> None:
        ...
        essential_modules: dict[str, MagicMock] = self._setup_dependencies(test_context)
        essential_modules["blind_x.ax_object"].AXObject.is_valid = test_context.Mock(
            return_value=False,
        )
        essential_modules["blind_x.ax_table"].AXTable.iter_visible_cells = test_context.Mock(
            return_value=[],
        )
        from blind_x.ax_utilities import AXUtilities
    ...
    def test_get_nesting_level_list_item(self, test_context: OrcaTestContext) -> None:
        ...
        essential_modules["blind_x.ax_utilities_role"].AXUtilitiesRole.is_list = test_context.Mock(
            return_value=True,
        )
        find_calls = []
        ...
        essential_modules["blind_x.ax_object"].AXObject.get_parent = test_context.Mock(
    ...
    def test_get_position_in_set_table_row_with_rowindex(
        ...
        essential_modules["blind_x.ax_object"].AXObject.get_attribute = mock_get_attribute
        from blind_x.ax_utilities import AXUtilities
    ...
    def test_get_set_members_internal_with_none_container(
        ...
        essential_modules["blind_x.ax_object"].AXObject.get_parent_checked = test_context.Mock(
            return_value=None,
        )
        from blind_x.ax_utilities import AXUtilities
    ...
    def test_get_set_members_internal_with_description_values(
        ...
        essential_modules["blind_x.ax_object"].AXObject.get_next_sibling = mock_get_next_sibling
        from blind_x.ax_utilities import AXUtilities
    ...
    def test_is_on_screen_scenarios(  # pylint: disable=too-many-positional-arguments,too-many-locals
        ...
        essential_modules["blind_x.ax_utilities_state"].AXUtilitiesState.is_hidden = test_context.Mock(
    ...
    def test_has_visible_caption_with_visible_caption(self, test_context: OrcaTestContext) -> None:
        ...
        essential_modules: dict[str, MagicMock] = self._setup_dependencies(test_context)
        essential_modules["blind_x.ax_utilities_role"].AXUtilitiesRole.is_figure = test_context.Mock(
            return_value=True,
        )
        essential_modules["blind_x.ax_object"].AXObject.supports_table = test_context.Mock(
            return_value=False,
        )
        essential_modules[
            "blind_x.ax_utilities_relation"
        ].AXUtilitiesRelation.get_is_labelled_by = test_context.Mock(return_value=[mock_caption])
        essential_modules["blind_x.ax_utilities_role"].AXUtilitiesRole.is_caption = test_context.Mock(
            return_value=True,
        )
        essential_modules[
            "blind_x.ax_utilities_state"
    ...
    def test_get_displayed_description_from_relations(self, test_context: OrcaTestContext) -> None:
        ...
        essential_modules["blind_x.ax_text"].AXText.get_all_text = test_context.Mock(return_value="")
        from blind_x.ax_utilities import AXUtilities
    ...
    def test_get_displayed_description_empty(self, test_context: OrcaTestContext) -> None:
        ...
        mock_obj = test_context.Mock(spec=Atspi.Accessible)
        essential_modules: dict[str, MagicMock] = self._setup_dependencies(test_context)
        essential_modules["blind_x.ax_object"].AXObject.get_description = test_context.Mock(
            return_value="",
        )
        from blind_x.ax_utilities import AXUtilities
    ...
    def test_get_position_in_set_with_large_child_count(
        ...
        essential_modules["blind_x.ax_object"].AXObject.get_index_in_parent = test_context.Mock(
            return_value=42,
        )
        from blind_x.ax_utilities import AXUtilities
    ...
    def test_treat_as_leaf_node_menu_non_aria_expanded(self, test_context: OrcaTestContext) -> None:
        ...
        essential_modules["blind_x.ax_utilities_role"].AXUtilitiesRole.is_menu = test_context.Mock(
            return_value=True,
        )
        essential_modules[
            "blind_x.ax_utilities_role"
    ...
    def test_get_set_size_table_cell_not_in_row(self, test_context: OrcaTestContext) -> None:
        ...
        essential_modules["blind_x.ax_utilities_table"].AXUtilitiesTable.get_table = test_context.Mock(
            return_value=mock_table,
        )
        essential_modules["blind_x.ax_table"].AXTable.get_row_count = test_context.Mock(
            return_value=15,
        )
        from blind_x.ax_utilities import AXUtilities
    ...
    def test_get_set_size_is_unknown_table_with_negative_counts(
        ...
        essential_modules["blind_x.ax_utilities_role"].AXUtilitiesRole.is_table = test_context.Mock(
            return_value=True,
        )
        essential_modules["blind_x.ax_object"].AXObject.get_attributes_dict = test_context.Mock(
    ...
    def test_get_position_in_set_table_cell_with_coordinates(
        ...
        essential_modules["blind_x.ax_table"].AXTable.get_cell_coordinates = test_context.Mock(
            return_value=(3, 2),
        )
        from blind_x.ax_utilities import AXUtilities
