...
def test_braille_filters_out_speech() -> None:
    ...
    from blind_x.output_reader import BrailleRecord, SpeechRecord, braille
...
def test_reader_parses_records_from_both_logs(tmp_path: Path) -> None:
    ...
    from blind_x.output_reader import BrailleRecord, OutputReader, SpeechRecord, braille, speech
...
def test_reader_ignores_malformed_and_unknown_kinds(tmp_path: Path) -> None:
    ...
    from blind_x.output_reader import OutputReader, speech
