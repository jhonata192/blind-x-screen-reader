...
class TestLivePoliteness:
    ...
    def test_politeness_values(self, test_context: OrcaTestContext) -> None:
        ...
        from blind_x.live_region_presenter import LivePoliteness
...
class TestLiveRegionMessage:
    ...
    def test_message_creation(self, test_context: OrcaTestContext) -> None:
        ...
        self._setup_dependencies(test_context)
        from blind_x.live_region_presenter import LivePoliteness, LiveRegionMessage
...
class TestLiveRegionMessageQueue:
    ...
    def test_queue_creation(self, test_context: OrcaTestContext) -> None:
        ...
        self._setup_dependencies(test_context)
        from blind_x.live_region_presenter import LiveRegionMessageQueue
    ...
    def test_enqueue_dequeue(self, test_context: OrcaTestContext) -> None:
        ...
        self._setup_dependencies(test_context)
        from blind_x.live_region_presenter import (
            LivePoliteness,
            LiveRegionMessage,
...
class TestLiveRegionPresenter:
    ...
    def _setup_dependencies(self, test_context: OrcaTestContext):
        ...
        axobject_mock = essential_modules["blind_x.AXObject"]
        ...
        axutilities_mock = essential_modules["blind_x.AXUtilities"]
    ...
    def test_init(self, test_context: OrcaTestContext) -> None:
        ...
        self._setup_dependencies(test_context)
        from blind_x.live_region_presenter import LiveRegionPresenter
    ...
    def test_reset(self, test_context: OrcaTestContext) -> None:
        ...
        self._setup_dependencies(test_context)
        from blind_x.live_region_presenter import LivePoliteness, LiveRegionPresenter
...
class TestLiveRegionPresenterModule:
    ...
    def _setup_dependencies(self, test_context: OrcaTestContext):
        ...
        essential_modules["blind_x.cmdnames"].LIVE_REGIONS_MONITOR = "test"
        essential_modules["blind_x.cmdnames"].LIVE_REGIONS_PREVIOUS = "test"
        essential_modules["blind_x.cmdnames"].LIVE_REGIONS_ADVANCE_POLITENESS = "test"
        essential_modules["blind_x.cmdnames"].LIVE_REGIONS_ARE_ANNOUNCED = "test"
        essential_modules["blind_x.cmdnames"].LIVE_REGIONS_NEXT = "test"
        ...
        essential_modules["blind_x.messages"].LIVE_REGIONS_SUPPORT_DISABLED = "test"
