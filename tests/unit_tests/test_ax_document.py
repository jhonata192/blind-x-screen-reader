...
class TestAXDocument:
    ...
    def _setup_dependencies(self, test_context: OrcaTestContext) -> dict[str, MagicMock]:
        ...
        ax_collection_mock = essential_modules["blind_x.ax_collection"].AXCollection
        ...
        ax_utilities_table_mock = essential_modules["blind_x.ax_utilities_table"].AXUtilitiesTable
    ...
    def test_document_methods_when_not_document(
        ...
        from blind_x.ax_document import AXDocument
