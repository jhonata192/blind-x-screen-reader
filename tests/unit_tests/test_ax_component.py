...
class TestAXComponent:
    ...
    def test_get_position(
        ...
        test_context.patch_object(
            essential_modules["blind_x.ax_object"].AXObject,
            "supports_component",
    ...
    def test_get_rect(self, test_context: OrcaTestContext, case: dict) -> None:
        ...
        essential_modules["blind_x.ax_object"].AXObject.supports_component = test_context.Mock(
    ...
    def test_object_contains_point(
        ...
        essential_modules["blind_x.ax_object"].AXObject.is_bogus = test_context.Mock(
