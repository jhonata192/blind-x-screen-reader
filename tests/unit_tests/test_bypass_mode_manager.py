...
class TestBypassModeManager:
    ...
    def _setup_dependencies(self, test_context: OrcaTestContext) -> dict[str, MagicMock]:
        ...
        cmdnames_mock.BYPASS_MODE_TOGGLE = "Toggle all Blind-X command keys"
        ...
        messages_mock.BYPASS_MODE_ENABLED = "Blind-X command keys off."
        messages_mock.BYPASS_MODE_DISABLED = "Blind-X command keys on."

        orca_modifier_manager_mock = essential_modules["blind_x.blind_x_modifier_manager"]
        modifier_manager_instance = test_context.Mock()
        modifier_manager_instance.unset_blind_x_modifiers = test_context.Mock()
        modifier_manager_instance.refresh_blind_x_modifiers = test_context.Mock()
        modifier_manager_instance.add_grabs_for_blind_x_modifiers = test_context.Mock()
        modifier_manager_instance.remove_grabs_for_blind_x_modifiers = test_context.Mock()
    ...
    def test_init(self, test_context: OrcaTestContext) -> None:
        ...
        from blind_x.bypass_mode_manager import BypassModeManager
    ...
    @pytest.mark.parametrize(
        ...
        [
            (
                ...
                True,
                True,
                "Blind-X command keys off.",
                "unset_blind_x_modifiers",
            ),
            (
                False,
                False,
            ...
            (
                ...
                True,
                False,
                "Blind-X command keys on.",
                "refresh_blind_x_modifiers",
            ),
            (
                True,
                False,
