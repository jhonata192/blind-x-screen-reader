...
class TestAXUtilitiesComponent:
    ...
    def _setup_dependencies(self, test_context: OrcaTestContext) -> dict[str, MagicMock]:
        ...
        additional_modules = ["blind_x.ax_utilities_role", "blind_x.ax_component"]
        ...
        essential_modules["blind_x.ax_component"].AXComponent = ax_component_class_mock
    ...
    def test_get_center_point(self, test_context: OrcaTestContext) -> None:
        ...
        from blind_x.ax_utilities_component import AXUtilitiesComponent
        ...
        mock_rect.width = 100
        mock_rect.height = 60
        essential_modules["blind_x.ax_component"].AXComponent.get_rect.return_value = mock_rect
    ...
    def test_object_intersects_rect(
        ...
        essential_modules["blind_x.ax_component"].AXComponent.get_rect.return_value = obj_rect
    ...
    def test_objects_have_same_rect(self, test_context: OrcaTestContext) -> None:
        ...
        essential_modules["blind_x.ax_component"].AXComponent.get_rect.side_effect = get_rect_for_obj
    ...
    def test_sort_objects_by_position_same_coordinates(self, test_context: OrcaTestContext) -> None:
        ...
        same_rect.x = 50
        same_rect.y = 50
        essential_modules["blind_x.ax_component"].AXComponent.get_rect.return_value = same_rect
        objects = [obj2, obj1]
        result = AXUtilitiesComponent.sort_objects_by_position(objects)
