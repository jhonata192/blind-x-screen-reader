...
class TestSpeechPresenter:
    ...
    def _setup_dependencies(self, test_context: OrcaTestContext) -> dict[str, MagicMock]:
        ...
        additional_modules = [
            ...
            "blind_x.preferences_grid_base",
            "blind_x.speech_manager",
            "blind_x.speech_monitor",
        ]
        essential_modules = test_context.setup_shared_dependencies(additional_modules)

        document_presenter_mock = essential_modules["blind_x.document_presenter"]
        ...
        ax_hypertext_mock = essential_modules["blind_x.ax_hypertext"]
        ...
        ax_document_mock = essential_modules["blind_x.ax_document"]
        ...
        mathsymbols_mock = essential_modules["blind_x.mathsymbols"]
        mathsymbols_mock.adjust_for_speech = test_context.Mock(side_effect=lambda x: x)

        object_properties_mock = essential_modules["blind_x.object_properties"]
        object_properties_mock.STATE_INVALID_GRAMMAR_SPEECH = "grammar error"

        pronunciation_dict_mock = essential_modules["blind_x.pronunciation_dictionary_manager"]
        ...
        orca_i18n_mock = essential_modules["blind_x.blind_x_i18n"]
    ...
    def test_init(self, test_context: OrcaTestContext) -> None:
        ...
        from blind_x.speech_presenter import SpeechPresenter

        presenter = SpeechPresenter()

        # Verify D-Bus registration occurred
        controller = essential_modules["blind_x.dbus_service"].get_remote_controller()
    ...
    def test_apply_speech_preferences(self, test_context: OrcaTestContext) -> None:
        ...
        self._setup_dependencies(test_context)
        from blind_x.speech_presenter import SpeechPreference, SpeechPresenter
    ...
    def test_should_verbalize_punctuation_true(self, test_context: OrcaTestContext) -> None:
        ...
        (
            essential_modules["blind_x.ax_utilities"].AXUtilities.find_ancestor_inclusive.return_value
        ) = mock_code_obj
        essential_modules["blind_x.ax_document"].AXDocument.is_plain_text.return_value = False
        mock_obj = test_context.Mock()
        result = SpeechPresenter._should_verbalize_punctuation(mock_obj)
        assert result is True
    ...
    def test_get_presenter_singleton(self, test_context: OrcaTestContext) -> None:
        ...
        self._setup_dependencies(test_context)
        from blind_x import speech_presenter
    ...
    def _setup_speech_output_dependencies(
        ...
        phonnames_mock = essential_modules["blind_x.phonnames"]
        ...
        speech_manager_mock = essential_modules["blind_x.speech_manager"]
    ...
    def test_get_voice_with_active_script(self, test_context: OrcaTestContext) -> None:
        ...
        script_manager = essential_modules["blind_x.script_manager"].get_manager()
    ...
    def test_speak_message_non_string(self, test_context: OrcaTestContext) -> None:
        ...
        essential_modules["blind_x.debug"].print_exception.assert_called()
    ...
    def test_spell_phonetically(self, test_context: OrcaTestContext) -> None:
        ...
        essential_modules["blind_x.phonnames"].get_phonetic_name.assert_called()
    ...
    def test_ensure_monitor_creates_when_enabled(self, test_context: OrcaTestContext) -> None:
        ...
        essential_modules = self._setup_dependencies(test_context)
        speech_monitor_mock = essential_modules["blind_x.speech_monitor"]
        from blind_x.speech_presenter import get_presenter
