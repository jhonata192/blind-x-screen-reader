...
def _setup_keybindings_dependencies(test_context: OrcaTestContext) -> None:
    ...
    test_context.patch_module("blind_x.blind_x_i18n", i18n_mock)
    ...
    test_context.patch_module("blind_x.input_event_manager", input_event_manager_mock)
...
class TestAltGrModifierSupport:
    ...
    def _create_binding(
        ...
        from blind_x.keybindings import KeyBinding
    ...
    def test_extra_altgr_prevents_match(self, test_context: OrcaTestContext) -> None:
        ...
        from blind_x.keybindings import ALTGR_MODIFIER_MASK, ORCA_MODIFIER_MASK
    ...
    def test_orca_modifier_enables_keycode_fallback(
        ...
        """Test that Blind-X modifier enables keycode fallback for AZERTY-like layouts."""

        _setup_keybindings_dependencies(test_context)
        from blind_x.keybindings import ORCA_MODIFIER_MASK
