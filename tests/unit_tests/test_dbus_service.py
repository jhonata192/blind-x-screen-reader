...
class TestDBusService:
    ...
    def _setup_dependencies(self, test_context: OrcaTestContext) -> dict[str, MagicMock]:
        ...
        essential_modules["blind_x.debug"].println = test_context.Mock()

        essential_modules["blind_x.orca_platform"].version = "test-version"
    ...
    def test_command_decorator(self, test_context: OrcaTestContext) -> None:
        ...
        from blind_x import dbus_service
    ...
    def test_show_preferences_success(self, test_context: OrcaTestContext) -> None:
        """Test BlindXDBusServiceInterface.ShowPreferences success."""
        ...
        test_context.patch("blind_x.script_manager.get_manager", return_value=mock_manager)
        service = dbus_service.BlindXDBusServiceInterface()
    ...
    def test_show_preferences_no_active_script(self, test_context: OrcaTestContext) -> None:
        """Test BlindXDBusServiceInterface.ShowPreferences no active script."""
    ...
    def test_show_preferences_no_script(self, test_context: OrcaTestContext) -> None:
        """Test BlindXDBusServiceInterface.ShowPreferences no script."""
    ...
    def test_present_message_success(self, test_context: OrcaTestContext) -> None:
        """Test BlindXDBusServiceInterface.PresentMessage success."""
    ...
    def test_present_message_no_script(self, test_context: OrcaTestContext) -> None:
        """Test BlindXDBusServiceInterface.PresentMessage works without active script."""
    ...
    def test_get_version_scenarios(self, test_context: OrcaTestContext, case: dict) -> None:
        """Test BlindXDBusServiceInterface.GetVersion with and without revision."""
        self._setup_dependencies(test_context)
        from blind_x import dbus_service
    ...
    def test_orca_remote_controller_constructor(self, test_context: OrcaTestContext) -> None:
        """Test BlindXRemoteController constructor."""

        self._setup_dependencies(test_context)
        from blind_x import dbus_service

        controller = dbus_service.BlindXRemoteController()
    ...
    def test_start_already_running(self, test_context: OrcaTestContext) -> None:
        """Test BlindXRemoteController.start already running."""
    ...
    def test_start_bus_error(self, test_context: OrcaTestContext) -> None:
        """Test BlindXRemoteController.start bus error."""
    ...
    def test_start_publish_error(self, test_context: OrcaTestContext) -> None:
        """Test BlindXRemoteController.start publish error."""
    ...
    def test_start_publish_error_with_cleanup(self, test_context: OrcaTestContext) -> None:
        """Test BlindXRemoteController.start publish error with cleanup."""
    ...
    def test_start_success(self, test_context: OrcaTestContext) -> None:
        """Test BlindXRemoteController.start success."""
    ...
    def test_shutdown_not_running(self, test_context: OrcaTestContext) -> None:
        """Test BlindXRemoteController.shutdown not running."""
    ...
    def test_shutdown_success(self, test_context: OrcaTestContext) -> None:
        """Test BlindXRemoteController.shutdown success."""
    ...
    def test_shutdown_unpublish_error(self, test_context: OrcaTestContext) -> None:
        """Test BlindXRemoteController.shutdown unpublish error."""
    ...
    def test_shutdown_unregister_error(self, test_context: OrcaTestContext) -> None:
        """Test BlindXRemoteController.shutdown unregister error."""
    ...
    def test_register_decorated_module_not_running(self, test_context: OrcaTestContext) -> None:
        """Test BlindXRemoteController.register_decorated_module not running."""
    ...
    def test_register_decorated_module_running(self, test_context: OrcaTestContext) -> None:
        """Test BlindXRemoteController.register_decorated_module running."""
    ...
    def test_deregister_module_commands_scenarios(
        ...
        """Test BlindXRemoteController.deregister_module_commands with various scenarios."""
        self._setup_dependencies(test_context)
        from blind_x import dbus_service
    ...
    def test_process_pending_registrations_empty(self, test_context: OrcaTestContext) -> None:
        """Test BlindXRemoteController._process_pending_registrations empty."""
    ...
    def test_process_pending_registrations_with_modules(
        ...
        """Test BlindXRemoteController._process_pending_registrations with modules."""
    ...
    def test_print_registration_summary(self, test_context: OrcaTestContext) -> None:
        """Test BlindXRemoteController._print_registration_summary."""
    ...
    def test_get_remote_controller(self, test_context: OrcaTestContext) -> None:
        ...
        assert isinstance(controller, dbus_service.BlindXRemoteController)

    def test_start_unpublish_object_error_during_cleanup(
        self,
        test_context: OrcaTestContext,
    ) -> None:
        """Test BlindXRemoteController.start unpublish object error during cleanup."""
    ...
    def test_module_registration_object_path_and_dbus_object(
        ...
        registration.set_object_path("/org/gnome/BlindX1/Service/FakeManager")
        sentinel = object()
        registration.set_dbus_object(sentinel)
        assert registration.get_object_path() == "/org/gnome/BlindX1/Service/FakeManager"
        assert registration.get_dbus_object() is sentinel


def _stub_blind_x_internals(test_context: OrcaTestContext) -> dict[str, object]:
    """Installs blind_x-internal stubs while leaving dasbus and gi real."""

    # _InterfaceBuilder relies on real dasbus introspection to build interface classes
    # from type annotations, so dasbus and gi must NOT be mocked here. Only blind_x.*
    ...
    platform_mod = types.ModuleType("blind_x.orca_platform")
    platform_mod.version = "test-version"
    platform_mod.revision = ""

    debug_mod = types.ModuleType("blind_x.debug")
    ...
    input_event_mod = types.ModuleType("blind_x.input_event")
    input_event_mod.RemoteControllerEvent = _RemoteControllerEvent

    iem_mod = types.ModuleType("blind_x.input_event_manager")
    iem_mod.get_manager = lambda: iem_instance

    sm_mod = types.ModuleType("blind_x.script_manager")
    sm_mod.get_manager = lambda: sm_instance

    stubs = {
        "blind_x.orca_platform": platform_mod,
        "blind_x.debug": debug_mod,
        "blind_x.input_event": input_event_mod,
        "blind_x.input_event_manager": iem_mod,
        "blind_x.script_manager": sm_mod,
    }
    test_context.patch_modules(stubs)

    sys.modules.pop("blind_x.dbus_service", None)
    return stubs
...
class TestInterfaceBuilder:
    ...
    def _interface_xml(self, cls):
        ...
        for iface in root.findall("interface"):
            if iface.get("name") == "org.gnome.BlindX1.FakeManager":
                return iface
        return None
    ...
    def test_simple_command_method_signature(self, test_context: OrcaTestContext) -> None:
        ...
        _stub_blind_x_internals(test_context)
        from blind_x import dbus_service
    ...
    def test_uint32_annotation_produces_unsigned_signature(
        ...
        _stub_blind_x_internals(test_context)
        from blind_x import dbus_service
        from blind_x.dbus_service import UInt32
        ...
        root = ET.fromstring(cls.__dbus_xml__)
        iface = next(
            i for i in root.findall("interface") if i.get("name") == "org.gnome.BlindX1.FakeManager"
        )
    ...
    def test_user_params_resolved_when_reserved_param_unresolvable(
        ...
        Real Blind-X modules type script as default.Script (a TYPE_CHECKING import).
        ...
        class TypeCheckingOnly:
            """Mirrors a real Blind-X presenter that types script as a TYPE_CHECKING-only ref."""
