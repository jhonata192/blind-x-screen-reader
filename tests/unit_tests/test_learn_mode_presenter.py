...
class TestLearnModePresenter:
    ...
    def _setup_dependencies(self, test_context: OrcaTestContext) -> dict[str, MagicMock]:
        ...
        messages_mock.VERSION = "Blind-X Version Information"
        ...
        messages_mock.shortcuts_found_blind_x = test_context.Mock(
            return_value="Found 25 Blind-X shortcuts",
        )
        ...
        speech_mock = essential_modules["blind_x.speech"]
    ...
    def test_init(self, test_context: OrcaTestContext) -> None:
        ...
        from blind_x.learn_mode_presenter import LearnModePresenter
    ...
    def test_start_when_inactive(self, test_context: OrcaTestContext) -> None:
        ...
        messages = essential_modules["blind_x.messages"]
        ...
        device_manager = essential_modules["blind_x.ax_device_manager"].get_manager.return_value
    ...
    def test_start_scenarios(
        ...
        if script_provided and script is not None:
            ...
            pres_manager.present_message.assert_called_with(
                essential_modules["blind_x.messages"].VERSION,
            )
    ...
    def test_quit_scenarios(
        ...
        if script_provided and script is not None:
            pres_manager = essential_modules["blind_x.presentation_manager"].get_manager()
            pres_manager.present_message.assert_called_with(
                essential_modules["blind_x.messages"].LEARN_MODE_STOP,
            )
    ...
    def test_handle_event_no_script(self, test_context: OrcaTestContext) -> None:
        ...
        presenter = LearnModePresenter()
        keyboard_event_cls = essential_modules["blind_x.input_event"].KeyboardEvent
    ...
    def test_handle_event_special_keys(
        ...
        event.modifiers = 0
        script_manager = essential_modules["blind_x.script_manager"]
    ...
    def test_list_orca_shortcuts_events(self, test_context: OrcaTestContext) -> None:
        """Test LearnModePresenter.list_blind_x_shortcuts with F2 event."""
        essential_modules: dict[str, MagicMock] = self._setup_dependencies(test_context)
        from blind_x.learn_mode_presenter import LearnModePresenter
        ...
        mock_gui = test_context.patch("blind_x.learn_mode_presenter.CommandListGUI")
        result = presenter.list_blind_x_shortcuts(script, event)
        assert result is True
