...
class TestBrailleLineRanges:
    ...
    def _setup_dependencies(self, test_context: OrcaTestContext) -> None:
        ...
        test_context.patch_modules(
            {
                "blind_x.braille_monitor": test_context.Mock(),
                "blind_x.braille_presenter": braille_presenter_mock,
                "blind_x.brltablenames": test_context.Mock(),
                "blind_x.cmdnames": test_context.Mock(),
                "blind_x.debug": debug_mock,
                "blind_x.script_manager": test_context.Mock(),
                "blind_x.text_attribute_manager": test_context.Mock(),
                "blind_x.ax_event_synthesizer": ax_event_synthesizer_mock,
                "blind_x.ax_hypertext": ax_hypertext_mock,
                "blind_x.ax_object": ax_object_mock,
                "blind_x.ax_text": ax_text_mock,
                "blind_x.ax_utilities": ax_utilities_mock,
                "blind_x.orca_platform": platform_mock,
            },
        )
    ...
    def test_prepare_refresh_disabled_shuts_down(self, test_context: OrcaTestContext) -> None:
        ...
        self._setup_dependencies(test_context)
        from blind_x import braille, braille_presenter
