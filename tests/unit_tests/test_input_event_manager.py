...
class TestInputEventManager:
    ...
    def _setup_dependencies(self, test_context: OrcaTestContext) -> dict[str, MagicMock]:
        ...
        additional_modules = ["blind_x.ax_utilities", "gi.repository"]
    ...
    def _setup_input_event_manager(self, test_context) -> tuple:
        ...
        test_context.patch("blind_x.input_event_manager.debug", new=essential_modules["blind_x.debug"])
        test_context.patch(
            "blind_x.input_event_manager.focus_manager",
            new=essential_modules["blind_x.focus_manager"],
        )
        test_context.patch(
            "blind_x.input_event_manager.script_manager",
            new=essential_modules["blind_x.script_manager"],
        )
        test_context.patch(
            "blind_x.input_event_manager.input_event",
            new=essential_modules["blind_x.input_event"],
        )
        test_context.patch(
            "blind_x.input_event_manager.AXUtilities",
            new=essential_modules["ax_utilities_class"],
        )
        test_context.patch("blind_x.input_event_manager.Atspi", new=essential_modules["atspi"])

        ax_device_mgr_mock = test_context.Mock()
        essential_modules["ax_device_manager"] = ax_device_mgr_mock
        test_context.patch("blind_x.input_event_manager.ax_device_manager", new=ax_device_mgr_mock)

        from blind_x.input_event_manager import InputEventManager
    ...
    def test_process_braille_event(self, test_context: OrcaTestContext) -> None:
        ...
        assert isinstance(
            ...
            essential_modules["blind_x.input_event"].BrailleEvent,
        )
        assert input_event_manager._last_non_modifier_key_event is None
    ...
    def test_process_mouse_button_event(self, test_context: OrcaTestContext) -> None:
        ...
        assert isinstance(
            input_event_manager._last_input_event,
            essential_modules["blind_x.input_event"].MouseButtonEvent,
        )
    ...
    def test_process_keyboard_event(self, test_context, case: dict) -> None:
        ...
        mock_focus_manager = essential_modules["blind_x.focus_manager"]
        ...
        mock_script_manager = essential_modules["blind_x.script_manager"]
        ...
        assert isinstance(
            input_event_manager._last_input_event,
            essential_modules["blind_x.input_event"].KeyboardEvent,
        )
    ...
    def test_process_keyboard_event_duplicate(self, test_context: OrcaTestContext) -> None:
        ...
        input_event_manager, essential_modules = self._setup_input_event_manager(test_context)
        mock_device = test_context.Mock()
        keyboard_event_instance = essential_modules["blind_x.input_event"].KeyboardEvent(
            True,
            65,
            97,
            0,
    ...
    def test_last_event_was_basic_event_types(
        ...
        if case["event_class_name"] == "KeyboardEvent":
            event_class = essential_modules["blind_x.input_event"].KeyboardEvent
            mock_event = event_class()
        elif case["event_class_name"] == "MouseButtonEvent":
            event_class = essential_modules["blind_x.input_event"].MouseButtonEvent
            mock_event = event_class()
        else:
            mock_event = test_context.Mock()
    ...
    def test_is_release_for(
        ...
        if event1 is not None and event2 is not None:
            keyboard_event_class = essential_modules["blind_x.input_event"].KeyboardEvent
    ...
    def test_last_event_was_command(
        ...
        if case["expects_debug"]:
            ...
            essential_modules["blind_x.debug"].print_message.assert_not_called()
    ...
    def test_last_event_was_shortcut_for(
        ...
        ax_utilities_class = essential_modules["blind_x.ax_utilities"].AXUtilities
    ...
    def test_last_event_was_line_navigation(
        ...
        mock_focus = test_context.Mock()
        essential_modules["blind_x.focus_manager"].get_locus_of_focus.return_value = mock_focus
    ...
    def test_get_manager(self, test_context: OrcaTestContext) -> None:
        ...
        from blind_x.input_event_manager import get_manager
    ...
    def test_determine_click_count_no_multi_click_bindings(
        ...
        test_context.patch(
            "blind_x.command_manager.get_manager",
            return_value=command_manager_instance,
        )

        # Create first event (press)
        first_event = essential_modules["blind_x.input_event"].KeyboardEvent(
            pressed=True,
            keycode=79,
            keysym=65429,
            modifiers=0,
        ...
        release_event = essential_modules["blind_x.input_event"].KeyboardEvent(
            pressed=False,
            keycode=79,
            keysym=65429,
            modifiers=0,
        ...
        second_event = essential_modules["blind_x.input_event"].KeyboardEvent(
            pressed=True,
            keycode=79,
            keysym=65429,
            modifiers=0,
        ...
        second_event.is_blind_x_modifier = test_context.Mock(return_value=False)
