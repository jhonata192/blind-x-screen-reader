# Unit tests for verifying all Blind-X commands are properly registered.
#
...
class TestCommandRegistry:
    """Tests for verifying all Blind-X commands are properly registered."""
    ...
    def _setup_dependencies(self, test_context: OrcaTestContext) -> dict[str, MagicMock]:
        ...
        additional_modules = [
            ...
            "blind_x.ax_table",
            "blind_x.ax_text",
            "blind_x.ax_event_synthesizer",
            "blind_x.speech_manager",
        ...
        flat_review_mock = essential_modules["blind_x.flat_review"]
    ...
    def _setup_speech_dependencies(self, test_context: OrcaTestContext) -> dict[str, MagicMock]:
        ...
        additional_modules = [
            "blind_x.mathsymbols",
            "blind_x.object_properties",
            "blind_x.pronunciation_dictionary_manager",
            "blind_x.speech",
            "blind_x.speechserver",
            "blind_x.acss",
            "blind_x.ax_hypertext",
            "blind_x.ax_table",
            "blind_x.ax_text",
        ...
        essential_modules["blind_x.blind_x_i18n"]._ = lambda x: x
        essential_modules["blind_x.blind_x_i18n"].C_ = lambda c, x: x
        essential_modules["blind_x.blind_x_i18n"].ngettext = lambda s, p, n: s if n == 1 else p
        ...
        essential_modules["blind_x.dbus_service"].getter = passthrough_decorator
        essential_modules["blind_x.dbus_service"].setter = passthrough_decorator
        essential_modules["blind_x.dbus_service"].command = passthrough_decorator
        essential_modules["blind_x.dbus_service"].parameterized_command = passthrough_decorator

        acss_mock = essential_modules["blind_x.acss"]
    ...
    def test_flat_review_presenter_handlers_exist(self, test_context: OrcaTestContext) -> None:
        ...
        from blind_x.flat_review_presenter import get_presenter
    ...
    def test_flat_review_finder_handlers_exist(self, test_context: OrcaTestContext) -> None:
        ...
        self._setup_dependencies(test_context)
        from blind_x import command_manager
        from blind_x.flat_review_finder import get_finder
    ...
    def test_notification_presenter_handlers_exist(self, test_context: OrcaTestContext) -> None:
        ...
        self._setup_dependencies(test_context)
        from blind_x import command_manager
        from blind_x.notification_presenter import get_presenter
    ...
    def test_system_information_presenter_handlers_exist(
        ...
        self._setup_dependencies(test_context)
        from blind_x import command_manager
        from blind_x.system_information_presenter import get_presenter
    ...
    def test_sleep_mode_manager_handlers_exist(self, test_context: OrcaTestContext) -> None:
        ...
        self._setup_dependencies(test_context)
        from blind_x import command_manager
        from blind_x.sleep_mode_manager import get_manager
    ...
    def test_live_region_presenter_handlers_exist(self, test_context: OrcaTestContext) -> None:
        ...
        self._setup_dependencies(test_context)
        from blind_x import command_manager
        from blind_x.live_region_presenter import get_presenter
    ...
    def test_chat_presenter_handlers_exist(self, test_context: OrcaTestContext) -> None:
        ...
        self._setup_dependencies(test_context)
        from blind_x import command_manager
        from blind_x.chat_presenter import get_presenter
    ...
    def test_learn_mode_presenter_handlers_exist(self, test_context: OrcaTestContext) -> None:
        ...
        self._setup_dependencies(test_context)
        from blind_x import command_manager
        from blind_x.learn_mode_presenter import get_presenter
    ...
    def test_action_presenter_handlers_exist(self, test_context: OrcaTestContext) -> None:
        ...
        self._setup_dependencies(test_context)
        from blind_x import command_manager
        from blind_x.action_presenter import get_presenter
    ...
    def test_debugging_tools_manager_handlers_exist(self, test_context: OrcaTestContext) -> None:
        ...
        self._setup_dependencies(test_context)
        from blind_x import command_manager
        from blind_x.debugging_tools_manager import get_manager
    ...
    def test_bypass_mode_manager_handlers_exist(self, test_context: OrcaTestContext) -> None:
        ...
        self._setup_dependencies(test_context)
        from blind_x import command_manager
        from blind_x.bypass_mode_manager import get_manager
    ...
    def test_mouse_review_handlers_exist(self, test_context: OrcaTestContext) -> None:
        ...
        self._setup_dependencies(test_context)
        from blind_x import command_manager
        from blind_x.mouse_review import get_reviewer
    ...
    def test_typing_echo_presenter_handlers_exist(self, test_context: OrcaTestContext) -> None:
        ...
        self._setup_dependencies(test_context)
        from blind_x import command_manager
        from blind_x.typing_echo_presenter import get_presenter
    ...
    def test_clipboard_handlers_exist(self, test_context: OrcaTestContext) -> None:
        ...
        self._setup_dependencies(test_context)
        from blind_x import command_manager
        from blind_x.clipboard import get_presenter
    ...
    def test_caret_navigator_handlers_exist(self, test_context: OrcaTestContext) -> None:
        ...
        from blind_x import command_manager
        from blind_x.caret_navigator import get_navigator
    ...
    def test_object_navigator_handlers_exist(self, test_context: OrcaTestContext) -> None:
        ...
        self._setup_dependencies(test_context)
        from blind_x import command_manager
        from blind_x.object_navigator import get_navigator
    ...
    def test_say_all_presenter_handlers_exist(self, test_context: OrcaTestContext) -> None:
        ...
        self._setup_structural_navigator_dependencies(test_context)
        from blind_x import command_manager
        from blind_x.say_all_presenter import get_presenter
    ...
    def test_speech_manager_handlers_exist(self, test_context: OrcaTestContext) -> None:
        ...
        from blind_x import command_manager
        from blind_x.speech_manager import get_manager
    ...
    def test_speech_presenter_handlers_exist(self, test_context: OrcaTestContext) -> None:
        ...
        self._setup_speech_dependencies(test_context)
        from blind_x import command_manager
        from blind_x.speech_presenter import get_presenter
    ...
    def test_document_presenter_handlers_exist(self, test_context: OrcaTestContext) -> None:
        ...
        self._setup_structural_navigator_dependencies(test_context)
        from blind_x import command_manager
        from blind_x.document_presenter import get_presenter
