...
class TestPresentationManager:
    ...
    def _setup_dependencies(self, test_context: OrcaTestContext) -> dict[str, MagicMock]:
        ...
        additional_modules = [
            ...
            "blind_x.live_region_presenter",
            "blind_x.sound_presenter",
            "blind_x.speech_manager",
            "blind_x.speech_presenter",
            "blind_x.typing_echo_presenter",
        ]
        ...
        live_region_presenter_mock = essential_modules["blind_x.live_region_presenter"]
        ...
        sound_presenter_mock = essential_modules["blind_x.sound_presenter"]
        ...
        speech_presenter_mock = essential_modules["blind_x.speech_presenter"]
        ...
        typing_echo_presenter_mock = essential_modules["blind_x.typing_echo_presenter"]
    ...
    def test_get_manager_returns_singleton(self, test_context: OrcaTestContext) -> None:
        ...
        from blind_x.presentation_manager import get_manager
    ...
    def test_interrupt_presentation(self, test_context: OrcaTestContext) -> None:
        ...
        speech_manager = essential_modules["blind_x.speech_manager"].get_manager()
        speech_manager.interrupt_speech.assert_called_once()
        braille_presenter = essential_modules["blind_x.braille_presenter"].get_presenter()
        braille_presenter.kill_flash.assert_called_once()
        live_region = essential_modules["blind_x.live_region_presenter"].get_presenter()
    ...
    def test_interrupt_presentation_without_kill_flash(self, test_context: OrcaTestContext) -> None:
        ...
        speech_manager = essential_modules["blind_x.speech_manager"].get_manager()
        speech_manager.interrupt_speech.assert_called_once()
        essential_modules["blind_x.braille"].killFlash.assert_not_called()
    ...
    def test_present_keyboard_event(self, test_context: OrcaTestContext) -> None:
        ...
        typing_echo = essential_modules["blind_x.typing_echo_presenter"].get_presenter()
    ...
    def test_present_key_event_delegates(self, test_context: OrcaTestContext) -> None:
        ...
        speech_pres = essential_modules["blind_x.speech_presenter"].get_presenter()
    ...
    def test_present_message_empty_string(self, test_context: OrcaTestContext) -> None:
        ...
        essential_modules["blind_x.braille"].displayMessage.assert_not_called()
    ...
    def test_present_message_speech_disabled(self, test_context: OrcaTestContext) -> None:
        ...
        essential_modules = self._setup_dependencies(test_context)
        speech_mgr = essential_modules["blind_x.speech_manager"].get_manager()
    ...
    def test_play_sound(self, test_context: OrcaTestContext) -> None:
        ...
        essential_modules = self._setup_dependencies(test_context)
        from blind_x.presentation_manager import PresentationManager

        mock_sound = test_context.Mock()
        PresentationManager.play_sound(mock_sound)

        sound_presenter = essential_modules["blind_x.sound_presenter"].get_presenter()
    ...
    def test_present_braille_message_braille_disabled(self, test_context: OrcaTestContext) -> None:
        ...
        essential_modules = self._setup_dependencies(test_context)
        braille_presenter_instance = essential_modules["blind_x.braille_presenter"].get_presenter()
