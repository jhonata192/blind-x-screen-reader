...
class TestAXUtilitiesDebugging:
    ...
    def _setup_dependencies(self, test_context: OrcaTestContext):
        ...
        additional_modules = ["blind_x.ax_utilities_application", "blind_x.ax_utilities_relation"]
    ...
    def test_format_string(  # pylint: disable=too-many-arguments,too-many-positional-arguments
        ...
        from blind_x.ax_utilities_debugging import AXUtilitiesDebugging
    ...
    def test_as_string_accessible_object(self, test_context: OrcaTestContext) -> None:
        ...
        test_context.patch(
            "blind_x.ax_utilities_debugging.AXObject.get_role_name",
            return_value="button",
        )
        test_context.patch("blind_x.ax_utilities_debugging.AXObject.get_name", return_value="OK")
    ...
    def test_as_string_accessible_dead_object(self, test_context: OrcaTestContext) -> None:
        ...
        test_context.patch("blind_x.ax_utilities_debugging.AXObject.get_role_name", return_value="")
        test_context.patch("blind_x.ax_utilities_debugging.AXObject.get_name", return_value="")
        result = AXUtilitiesDebugging.as_string(mock_obj)
    ...
    def test_as_string_event_object(self, test_context: OrcaTestContext) -> None:
        ...
        test_context.patch("blind_x.ax_utilities_debugging.AXObject.get_name", return_value="OK")
        test_context.patch(
            "blind_x.ax_utilities_debugging.AXUtilitiesApplication.application_as_string",
    ...
    def test_actions_as_string(self, test_context: OrcaTestContext) -> None:
        ...
        test_context.patch("blind_x.ax_utilities_debugging.AXAction.get_n_actions", return_value=2)
        ...
        test_context.patch(
            "blind_x.ax_utilities_debugging.AXAction.get_action_name",
            new=mock_get_action_name,
        )
        test_context.patch(
            "blind_x.ax_utilities_debugging.AXAction.get_action_key_binding",
    ...
    def test_attributes_as_string(self, test_context: OrcaTestContext) -> None:
        ...
        test_context.patch(
            "blind_x.ax_utilities_debugging.AXObject.get_attributes_dict",
    ...
    def test_interfaces_as_string(self, test_context: OrcaTestContext) -> None:
        ...
        mock_obj = test_context.Mock(spec=Atspi.Accessible)
        test_context.patch("blind_x.ax_utilities_debugging.AXObject.is_valid", return_value=False)
        ...
        for method_name, return_value in interface_support.items():
            test_context.patch(
                f"blind_x.ax_utilities_debugging.AXObject.{method_name}",
    ...
    def test_state_set_as_string(self, test_context: OrcaTestContext) -> None:
        ...
        test_context.patch("blind_x.ax_utilities_debugging.AXObject.is_valid", return_value=True)
        ...
        test_context.patch(
            "blind_x.ax_utilities_debugging.AXObject.get_state_set",
    ...
    def test_text_for_debugging(
        ...
        test_context.patch(
            "blind_x.ax_utilities_debugging.AXObject.supports_text",
    ...
    def test_object_details_as_string_basic(self, test_context: OrcaTestContext) -> None:
        ...
        mock_obj = test_context.Mock(spec=Atspi.Accessible)
        test_context.patch("blind_x.ax_utilities_debugging.AXObject.is_dead", return_value=True)
    ...
    def test_relations_as_string(self, test_context: OrcaTestContext) -> None:
        ...
        test_context.patch(
            "blind_x.ax_utilities_debugging.AXUtilitiesRelation.get_relations",
            return_value=[mock_relation],
        )
        test_context.patch(
            "blind_x.ax_utilities_debugging.AXUtilitiesRelation.get_relation_targets_for_debugging",
        ...
        test_context.patch("blind_x.ax_utilities_debugging.AXObject.get_name", return_value="Username")
        result = AXUtilitiesDebugging.relations_as_string(mock_obj)
    ...
    def test_object_details_as_string_complete(self, test_context: OrcaTestContext) -> None:
        ...
        test_context.patch("blind_x.ax_utilities_debugging.AXObject.is_dead", return_value=False)
        ...
        test_context.patch(
            "blind_x.ax_utilities_debugging.AXObject.get_name",
        ...
        test_context.patch(
            "blind_x.ax_utilities_debugging.AXObject.get_description",
            return_value="button desc",
        )
        test_context.patch(
            "blind_x.ax_utilities_debugging.AXObject.get_help_text",
            return_value="button help",
        )
        test_context.patch(
            "blind_x.ax_utilities_debugging.AXObject.get_accessible_id",
            return_value="btn1",
        )
        test_context.patch("blind_x.ax_utilities_debugging.AXObject.get_path", return_value=[0, 1, 2])
