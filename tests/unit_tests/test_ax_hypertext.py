...
class TestAXHypertext:
    ...
    def test_get_link_count_with_hypertext_support(self, test_context: OrcaTestContext) -> None:
        ...
        from blind_x.ax_hypertext import AXHypertext

        test_context.patch("blind_x.ax_hypertext.AXObject.supports_hypertext", return_value=True)
        test_context.patch("blind_x.ax_hypertext.Atspi.Hypertext.get_n_links", return_value=3)
    ...
    def test_get_link_count_without_hypertext_support(self, test_context: OrcaTestContext) -> None:
        ...
        test_context.patch("blind_x.ax_hypertext.AXObject.supports_hypertext", return_value=False)
        result = AXHypertext._get_link_count(mock_accessible)
        assert result == 0
    ...
    def test_get_link_count_with_glib_error(self, test_context: OrcaTestContext) -> None:
        ...
        test_context.patch("blind_x.ax_hypertext.AXObject.supports_hypertext", return_value=True)
        test_context.patch(
            "blind_x.ax_hypertext.Atspi.Hypertext.get_n_links",
            side_effect=raise_glib_error,
        )
        test_context.patch(
            "blind_x.ax_hypertext.debug.print_message",
            new=essential_modules["blind_x.debug"].print_message,
        )
        result = AXHypertext._get_link_count(mock_accessible)
        assert result == 0
        essential_modules["blind_x.debug"].print_message.assert_called()
    ...
    def test_get_link_at_index_scenarios(
        ...
        test_context.patch(
            "blind_x.ax_hypertext.AXObject.supports_hypertext",
        ...
        if raises_glib_error:
            ...
            test_context.patch(
                "blind_x.ax_hypertext.Atspi.Hypertext.get_link",
                side_effect=raise_glib_error,
            )
            test_context.patch(
                "blind_x.ax_hypertext.debug.print_message",
    ...
    def test_get_all_links_in_range(  # pylint: disable=too-many-arguments, too-many-positional-arguments
        ...
        test_context.patch(
            "blind_x.ax_hypertext.AXHypertext._get_link_count",
        ...
        test_context.patch(
            "blind_x.ax_hypertext.AXHypertext._get_link_at_index",
            side_effect=mock_get_link_at_index,
        )
        test_context.patch(
            "blind_x.ax_hypertext.AXHypertext.get_link_start_offset",
            side_effect=lambda link: get_offset(link, True),
        )
        test_context.patch(
            "blind_x.ax_hypertext.AXHypertext.get_link_end_offset",
    ...
    def test_get_all_links_empty_object(self, test_context: OrcaTestContext) -> None:
        ...
        test_context.patch("blind_x.ax_hypertext.AXHypertext._get_link_count", return_value=0)
    ...
    def test_get_all_links_with_valid_links(self, test_context: OrcaTestContext) -> None:
        ...
        test_context.patch("blind_x.ax_hypertext.AXHypertext._get_link_count", return_value=2)
    ...
    def test_get_all_links_filters_none_values(self, test_context: OrcaTestContext) -> None:
        ...
        test_context.patch("blind_x.ax_hypertext.AXHypertext._get_link_count", return_value=3)
    ...
    def test_get_link_uri_with_valid_hyperlink(self, test_context: OrcaTestContext) -> None:
        ...
        test_context.patch(
            "blind_x.ax_hypertext.Atspi.Accessible.get_hyperlink",
            return_value=mock_hyperlink,
        )
        test_context.patch(
            "blind_x.ax_hypertext.Atspi.Hyperlink.get_uri",
    ...
    def test_get_link_start_offset(
        ...
        test_context.patch(
            "blind_x.ax_hypertext.Atspi.Hyperlink.get_start_index",
    ...
    def test_get_link_start_offset_no_hyperlink(self, test_context: OrcaTestContext) -> None:
        ...
        test_context.patch("blind_x.ax_hypertext.Atspi.Accessible.get_hyperlink", return_value=None)
    ...
    def test_get_link_end_offset(
        ...
        if input_type == "accessible":
            ...
            input_obj = mock_hyperlink
        test_context.patch(
            "blind_x.ax_hypertext.Atspi.Hyperlink.get_end_index",
            return_value=expected_offset,
        )
    ...
    def test_get_link_basename(
        ...
        test_context.patch("blind_x.ax_hypertext.AXHypertext.get_link_uri", return_value=uri)
    ...
    def test_get_child_at_offset_with_valid_link(self, test_context: OrcaTestContext) -> None:
        ...
        test_context.patch("blind_x.ax_hypertext.AXObject.supports_hypertext", return_value=True)
        test_context.patch("blind_x.ax_hypertext.Atspi.Hypertext.get_link_index", return_value=0)
        test_context.patch(
            "blind_x.ax_hypertext.AXHypertext._get_link_at_index",
            return_value=mock_hyperlink,
        )
        test_context.patch(
            "blind_x.ax_hypertext.Atspi.Hyperlink.get_object",
    ...
    def test_get_child_at_offset_no_link_at_index(self, test_context: OrcaTestContext) -> None:
        ...
        test_context.patch("blind_x.ax_hypertext.AXObject.supports_hypertext", return_value=True)
        test_context.patch("blind_x.ax_hypertext.Atspi.Hypertext.get_link_index", return_value=-1)
        result = AXHypertext.get_child_at_offset(mock_accessible, 5)
        assert result is None
    ...
    def test_get_child_at_offset_with_glib_error_get_link_index(
        ...
        test_context.patch("blind_x.ax_hypertext.AXObject.supports_hypertext", return_value=True)
        test_context.patch(
            "blind_x.ax_hypertext.Atspi.Hypertext.get_link_index",
            side_effect=raise_glib_error,
        )
        test_context.patch(
            "blind_x.ax_hypertext.debug.print_message",
    ...
    def test_get_character_offset_in_parent_with_text_parent(
        ...
        test_context.patch("blind_x.ax_hypertext.AXObject.get_parent", return_value=mock_parent)
        test_context.patch("blind_x.ax_hypertext.AXObject.supports_text", return_value=True)
        test_context.patch("blind_x.ax_hypertext.AXHypertext.get_link_start_offset", return_value=10)
    ...
    def test_get_character_offset_in_parent_without_text_parent(
        ...
        mock_parent = test_context.Mock(spec=Atspi.Accessible)
        test_context.patch("blind_x.ax_hypertext.AXObject.get_parent", return_value=mock_parent)
        test_context.patch("blind_x.ax_hypertext.AXObject.supports_text", return_value=False)
        result = AXHypertext.get_character_offset_in_parent(mock_accessible)
        assert result == -1
    ...
    def test_get_character_offset_in_parent_no_parent(self, test_context: OrcaTestContext) -> None:
        ...
        test_context.patch("blind_x.ax_hypertext.AXObject.get_parent", return_value=None)
        test_context.patch("blind_x.ax_hypertext.Atspi.Accessible.get_hyperlink", return_value=None)
        result = AXHypertext.get_character_offset_in_parent(mock_accessible)
        assert result == -1
