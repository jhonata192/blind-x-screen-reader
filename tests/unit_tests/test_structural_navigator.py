...
class TestStructuralNavigator:
    ...
    def _setup_dependencies(self, test_context):
        ...
        additional_modules = [
            "blind_x.cmdnames",
            "blind_x.command_manager",
            "blind_x.dbus_service",
            "blind_x.debug",
            "blind_x.focus_manager",
            "blind_x.guilabels",
            "blind_x.input_event_manager",
            "blind_x.keybindings",
            "blind_x.messages",
            "blind_x.object_properties",
            "blind_x.blind_x_gui_navlist",
            ...
            "blind_x.AXUtilities",
            "blind_x.input_event",
            "blind_x.braille_presenter",
            "blind_x.presentation_manager",
        ]
    ...
    def _setup_mocks(self, test_context, essential_modules) -> None:
        ...
        essential_modules["blind_x.input_event"].InputEventHandler = test_context.Mock(
            return_value=input_event_handler_mock,
        )
        key_bindings_instance = test_context.Mock()
        essential_modules["blind_x.keybindings"].KeyBindings = test_context.Mock(
        ...
        essential_modules["blind_x.dbus_service"].get_remote_controller.return_value = controller_mock
        essential_modules["blind_x.debug"].print_message = test_context.Mock()
        essential_modules["blind_x.debug"].LEVEL_INFO = 800
        focus_manager_instance = test_context.Mock()
        focus_manager_instance.get_locus_of_focus.return_value = None
        essential_modules["blind_x.focus_manager"].get_manager.return_value = focus_manager_instance
        essential_modules["blind_x.AXObject"].get_parent.return_value = None
        essential_modules["blind_x.AXObject"].supports_collection.return_value = True
        essential_modules["blind_x.AXObject"].find_ancestor.return_value = None
        essential_modules["blind_x.AXObject"].get_attributes_dict.return_value = {}
        essential_modules["blind_x.AXUtilities"].is_web_application.return_value = False
        essential_modules["blind_x.AXUtilities"].is_heading.return_value = False
        essential_modules["blind_x.AXUtilities"].is_live_region.return_value = False
        essential_modules["blind_x.AXUtilities"].find_descendant.return_value = None
        script_manager_instance = test_context.Mock()
        script_manager_instance.get_active_script.return_value = None
        essential_modules["blind_x.script_manager"].get_manager.return_value = script_manager_instance
        essential_modules["blind_x.blind_x_i18n"]._ = lambda msg: msg
        essential_modules["blind_x.messages"].STRUCTURAL_NAVIGATION_KEYS_DOCUMENT = "Document mode"
        essential_modules["blind_x.messages"].STRUCTURAL_NAVIGATION_KEYS_GUI = "GUI mode"
        essential_modules["blind_x.messages"].STRUCTURAL_NAVIGATION_KEYS_OFF = "Off mode"
        essential_modules[
            "blind_x.messages"
        ...
        essential_modules["blind_x.messages"].WRAPPING_TO_TOP = "Wrapping to top"
        essential_modules["blind_x.messages"].WRAPPING_TO_BOTTOM = "Wrapping to bottom"
        essential_modules["blind_x.cmdnames"].STRUCTURAL_NAVIGATION_MODE_CYCLE = "cycle_mode"
        essential_modules["blind_x.cmdnames"].BLOCKQUOTE_PREV = "previous_blockquote"
        essential_modules["blind_x.cmdnames"].BLOCKQUOTE_NEXT = "next_blockquote"
        essential_modules["blind_x.cmdnames"].BLOCKQUOTE_LIST = "list_blockquotes"
        essential_modules["blind_x.cmdnames"].BUTTON_PREV = "previous_button"
        essential_modules["blind_x.cmdnames"].BUTTON_NEXT = "next_button"
        essential_modules["blind_x.cmdnames"].BUTTON_LIST = "list_buttons"
        essential_modules["blind_x.cmdnames"].CHECK_BOX_PREV = "previous_checkbox"
        essential_modules["blind_x.cmdnames"].CHECK_BOX_NEXT = "next_checkbox"
        essential_modules["blind_x.cmdnames"].CHECK_BOX_LIST = "list_checkboxes"
        essential_modules["blind_x.cmdnames"].COMBO_BOX_PREV = "previous_combobox"
        essential_modules["blind_x.cmdnames"].COMBO_BOX_NEXT = "next_combobox"
        essential_modules["blind_x.cmdnames"].COMBO_BOX_LIST = "list_comboboxes"
        essential_modules["blind_x.cmdnames"].ENTRY_PREV = "previous_entry"
        essential_modules["blind_x.cmdnames"].ENTRY_NEXT = "next_entry"
        essential_modules["blind_x.cmdnames"].ENTRY_LIST = "list_entries"
        essential_modules["blind_x.cmdnames"].FORM_FIELD_PREV = "previous_form_field"
        essential_modules["blind_x.cmdnames"].FORM_FIELD_NEXT = "next_form_field"
        essential_modules["blind_x.cmdnames"].FORM_FIELD_LIST = "list_form_fields"
        essential_modules["blind_x.cmdnames"].HEADING_PREV = "previous_heading"
        essential_modules["blind_x.cmdnames"].HEADING_NEXT = "next_heading"
        essential_modules["blind_x.cmdnames"].HEADING_LIST = "list_headings"
        essential_modules["blind_x.cmdnames"].HEADING_AT_LEVEL_PREV = "previous_heading_level_%d"
        essential_modules["blind_x.cmdnames"].HEADING_AT_LEVEL_NEXT = "next_heading_level_%d"
        essential_modules["blind_x.cmdnames"].HEADING_AT_LEVEL_LIST = "list_headings_level_%d"
        essential_modules["blind_x.cmdnames"].IFRAME_PREV = "previous_iframe"
        essential_modules["blind_x.cmdnames"].IFRAME_NEXT = "next_iframe"
        essential_modules["blind_x.cmdnames"].IFRAME_LIST = "list_iframes"
        essential_modules["blind_x.cmdnames"].IMAGE_PREV = "previous_image"
        essential_modules["blind_x.cmdnames"].IMAGE_NEXT = "next_image"
        essential_modules["blind_x.cmdnames"].IMAGE_LIST = "list_images"
        essential_modules["blind_x.cmdnames"].LANDMARK_PREV = "previous_landmark"
        essential_modules["blind_x.cmdnames"].LANDMARK_NEXT = "next_landmark"
        essential_modules["blind_x.cmdnames"].LANDMARK_LIST = "list_landmarks"
        essential_modules["blind_x.cmdnames"].LIST_PREV = "previous_list"
        essential_modules["blind_x.cmdnames"].LIST_NEXT = "next_list"
        essential_modules["blind_x.cmdnames"].LIST_LIST = "list_lists"
        essential_modules["blind_x.cmdnames"].LIST_ITEM_PREV = "previous_list_item"
        essential_modules["blind_x.cmdnames"].LIST_ITEM_NEXT = "next_list_item"
        essential_modules["blind_x.cmdnames"].LIST_ITEM_LIST = "list_list_items"
        essential_modules["blind_x.cmdnames"].LIVE_REGION_PREV = "previous_live_region"
        essential_modules["blind_x.cmdnames"].LIVE_REGION_NEXT = "next_live_region"
        essential_modules["blind_x.cmdnames"].LIVE_REGION_LAST = "last_live_region"
        essential_modules["blind_x.cmdnames"].PARAGRAPH_PREV = "previous_paragraph"
        essential_modules["blind_x.cmdnames"].PARAGRAPH_NEXT = "next_paragraph"
        essential_modules["blind_x.cmdnames"].PARAGRAPH_LIST = "list_paragraphs"
        essential_modules["blind_x.cmdnames"].RADIO_BUTTON_PREV = "previous_radio_button"
        essential_modules["blind_x.cmdnames"].RADIO_BUTTON_NEXT = "next_radio_button"
        essential_modules["blind_x.cmdnames"].RADIO_BUTTON_LIST = "list_radio_buttons"
        essential_modules["blind_x.cmdnames"].SEPARATOR_PREV = "previous_separator"
        essential_modules["blind_x.cmdnames"].SEPARATOR_NEXT = "next_separator"
        essential_modules["blind_x.cmdnames"].TABLE_PREV = "previous_table"
        essential_modules["blind_x.cmdnames"].TABLE_NEXT = "next_table"
        essential_modules["blind_x.cmdnames"].TABLE_LIST = "list_tables"
        essential_modules["blind_x.cmdnames"].LINK_PREV = "previous_link"
        essential_modules["blind_x.cmdnames"].LINK_NEXT = "next_link"
        essential_modules["blind_x.cmdnames"].LINK_LIST = "list_links"
        essential_modules["blind_x.cmdnames"].UNVISITED_LINK_PREV = "previous_unvisited_link"
        essential_modules["blind_x.cmdnames"].UNVISITED_LINK_NEXT = "next_unvisited_link"
        essential_modules["blind_x.cmdnames"].UNVISITED_LINK_LIST = "list_unvisited_links"
        essential_modules["blind_x.cmdnames"].VISITED_LINK_PREV = "previous_visited_link"
        essential_modules["blind_x.cmdnames"].VISITED_LINK_NEXT = "next_visited_link"
        essential_modules["blind_x.cmdnames"].VISITED_LINK_LIST = "list_visited_links"
        essential_modules["blind_x.cmdnames"].LARGE_OBJECT_PREV = "previous_large_object"
        essential_modules["blind_x.cmdnames"].LARGE_OBJECT_NEXT = "next_large_object"
        essential_modules["blind_x.cmdnames"].LARGE_OBJECT_LIST = "list_large_objects"
        essential_modules["blind_x.cmdnames"].CLICKABLE_PREV = "previous_clickable"
        essential_modules["blind_x.cmdnames"].CLICKABLE_NEXT = "next_clickable"
        essential_modules["blind_x.cmdnames"].CLICKABLE_LIST = "list_clickables"
    ...
    def test_init(self, test_context: OrcaTestContext) -> None:
        ...
        from blind_x import command_manager
        from blind_x.structural_navigator import get_navigator
    ...
    def test_cycle_mode_transitions(
        ...
        from blind_x.structural_navigator import NavigationMode, get_navigator
        ...
        pres_manager = essential_modules["blind_x.presentation_manager"].get_manager()
    ...
    def test_suspend_commands_scenarios(
        ...
        essential_modules["blind_x.command_manager"].get_manager.return_value = mock_cmd_mgr
        ...
        if expects_debug:
            essential_modules["blind_x.debug"].print_message.assert_any_call(
                essential_modules["blind_x.debug"].LEVEL_INFO,
    ...
    def test_get_object_in_direction_next_object(self, test_context: OrcaTestContext) -> None:
        ...
        essential_modules["blind_x.AXObject"].get_parent.return_value = mock_obj2
        ...
        essential_modules["blind_x.AXObject"].get_path.side_effect = mock_get_path
    ...
    def test_get_object_in_direction_previous_object(self, test_context: OrcaTestContext) -> None:
        ...
        essential_modules = self._setup_dependencies(test_context)
        from blind_x import ax_utilities
        from blind_x.structural_navigator import get_navigator
    ...
    def test_determine_root_container_document_mode(self, test_context: OrcaTestContext) -> None:
        ...
        essential_modules["blind_x.AXObject"].find_ancestor_inclusive.side_effect = (
    ...
    def test_determine_root_container_fallback(self, test_context: OrcaTestContext) -> None:
        ...
        essential_modules["blind_x.AXUtilities"].is_web_application.return_value = False
        essential_modules["blind_x.AXObject"].find_ancestor_inclusive.return_value = mock_app
        from blind_x.structural_navigator import get_navigator
    ...
    def test_get_all_elements(
        ...
        if element_type == "lists":
            test_context.patch(
                f"blind_x.structural_navigator.AXUtilities.{ax_method}",
    ...
    def test_get_state_string(self, test_context: OrcaTestContext) -> None:
        ...
        nav = get_navigator()
        essential_modules["blind_x.AXObject"].get_state_set.return_value = None
        essential_modules["blind_x.AXUtilities"].is_switch.return_value = False
        essential_modules["blind_x.AXUtilities"].is_checked.return_value = False
        essential_modules["blind_x.AXUtilities"].is_expanded.return_value = False
        essential_modules["blind_x.AXUtilities"].is_pressed.return_value = False
        essential_modules["blind_x.AXUtilities"].is_selected.return_value = False
    ...
    def test_is_non_document_object(self, test_context: OrcaTestContext) -> None:
        ...
        nav = get_navigator()
        essential_modules["blind_x.AXUtilities"].is_application.return_value = False
        essential_modules["blind_x.AXUtilities"].is_document.return_value = False
        essential_modules["blind_x.AXUtilities"].is_frame.return_value = False
        essential_modules["blind_x.AXObject"].get_role.return_value = None
    ...
    def test_heading_level_navigation_methods_exist(
        ...
        from blind_x.structural_navigator import StructuralNavigator
    ...
    def test_navigation_mode_values(
        ...
        from blind_x.structural_navigator import NavigationMode
    ...
    def test_set_is_enabled_true_with_previous_mode(self, test_context: OrcaTestContext) -> None:
        ...
        from blind_x import gsettings_registry
        from blind_x.structural_navigator import NavigationMode, get_navigator
    ...
    def test_present_line_emits_region_changed(self, test_context: OrcaTestContext) -> None:
        ...
        essential_modules = self._setup_dependencies(test_context)
        from blind_x import focus_manager
        from blind_x.structural_navigator import NavigationMode, get_navigator
