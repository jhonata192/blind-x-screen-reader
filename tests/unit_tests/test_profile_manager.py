...
class TestProfileManager:
    ...
    def _setup_dependencies(self, test_context: OrcaTestContext) -> dict[str, MagicMock]:
        ...
        test_context.patch(
            "blind_x.profile_manager.ProfileManager._get_stored_profiles",
            return_value=[
                ["Default", "default"],
                ["Spanish", "spanish"],
                ["Work", "work"],
        ...
        blind_x_mock = essential_modules["blind_x.orca"]
    ...
    def test_get_active_profile(self, test_context: OrcaTestContext) -> None:
        ...
        from blind_x.profile_manager import ProfileManager
    ...
    def test_load_profile(self, test_context: OrcaTestContext) -> None:
        ...
        assert gsettings_registry.get_registry().get_active_profile() == "spanish"
        blind_x_mock.load_user_settings.assert_called_once_with(
    ...
    def test_remove_profile(self, test_context: OrcaTestContext) -> None:
        ...
        mock_run.assert_called_once_with(
            ["dconf", "reset", "-f", "/org/gnome/blind-x/spanish/"],
            check=True,
        )
    ...
    def test_remove_profile_sanitizes_name(self, test_context: OrcaTestContext) -> None:
        ...
        mock_run.assert_called_once_with(
            ["dconf", "reset", "-f", "/org/gnome/blind-x/my-profile/"],
            check=True,
        )
...
class TestProfilePreferencesGridUI:
    ...
    def test_grid_creates_successfully(self, test_context: OrcaTestContext) -> None:
        ...
        self._setup_dependencies(test_context)
        from blind_x.profile_manager import ProfileManager, ProfilePreferencesGrid
