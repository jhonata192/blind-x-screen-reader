...
class TestSpeechManager:
    ...
    def _setup_dependencies(self, test_context: OrcaTestContext) -> dict[str, MagicMock]:
        ...
        speechserver_mock = essential_modules["blind_x.speechserver"]
        ...
        from blind_x.speechserver import VoiceType
    ...
    def test_init(self, test_context: OrcaTestContext) -> None:
        ...
        from blind_x.speech_manager import SpeechManager
    ...
    def test_get_server_module_map_import_errors(self, test_context: OrcaTestContext) -> None:
        ...
        self._setup_dependencies(test_context)
        from blind_x import speech_manager as sm_module
        from blind_x.speech_manager import SpeechManager
    ...
    def test_get_manager_singleton(self, test_context: OrcaTestContext) -> None:
        ...
        self._setup_dependencies(test_context)
        from blind_x import speech_manager
...
class TestVoicesPreferencesGridUI:
    ...
    def test_save_settings_includes_speech_server_factory(
        ...
        from blind_x import gsettings_registry
        from blind_x.speech_manager import SpeechManager, VoicesPreferencesGrid
