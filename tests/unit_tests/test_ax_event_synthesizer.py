...
class TestAXEventSynthesizer:
    ...
    def _setup_dependencies(self, test_context: OrcaTestContext) -> dict[str, MagicMock]:
        ...
        ax_component_mock = essential_modules["blind_x.ax_component"].AXComponent
        ...
        ax_text_mock = essential_modules["blind_x.ax_text"].AXText
        ...
        ax_utilities_role_mock = essential_modules["blind_x.ax_utilities_role"].AXUtilitiesRole
    ...
    def _setup_successful_mouse_event_mocks(self, test_context, essential_modules) -> None:
        ...
        ax_uc_mock = essential_modules["blind_x.ax_utilities_component"].AXUtilitiesComponent
    ...
    def test_highest_ancestor_true_when_parent_is_none(self, test_context: OrcaTestContext) -> None:
        ...
        from blind_x.ax_event_synthesizer import AXEventSynthesizer

        mock_accessible = test_context.Mock(spec=Atspi.Accessible)
        ax_object_mock = essential_modules["blind_x.ax_object"].AXObject
    ...
    def test_generate_mouse_event_success(self, test_context: OrcaTestContext) -> None:
        ...
        mock_accessible = test_context.Mock(spec=Atspi.Accessible)
        ax_device_mgr = essential_modules["blind_x.ax_device_manager"]
    ...
    def test_try_all_clickable_actions_success_on_first_action(
        ...
        mock_accessible = test_context.Mock(spec=Atspi.Accessible)
        ax_utilities_action_mock = essential_modules["blind_x.ax_utilities_action"].AXUtilitiesAction
    ...
    def test_get_synthesizer_returns_singleton(self, test_context: OrcaTestContext) -> None:
        ...
        self._setup_dependencies(test_context)
        from blind_x.ax_event_synthesizer import get_synthesizer
    ...
    def test_scroll_methods_with_fallback(  # pylint: disable=too-many-arguments,too-many-positional-arguments,too-many-locals
        ...
        if position_changes:
            ...
            assert essential_modules["blind_x.debug"].print_tokens.call_count == 1
        else:
            if "location" in method_name:
            ...
            assert essential_modules["blind_x.debug"].print_tokens.call_count == 2
