...
class TestAXUtilitiesAction:
    ...
    def test_get_action_names_no_actions(self, test_context: OrcaTestContext) -> None:
        ...
        from blind_x.ax_action import AXAction
        from blind_x.ax_utilities_action import AXUtilitiesAction
    ...
    def test_get_label_for_key_sequence(
        ...
        if case["sequence"]:
            gi_repo = test_context.patch("blind_x.ax_utilities_action.Gtk")
