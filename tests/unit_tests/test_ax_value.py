...
class TestAXValue:
    ...
    def _setup_dependencies(self, test_context: OrcaTestContext) -> dict[str, MagicMock]:
        ...
        additional_modules = ["blind_x.ax_utilities", "blind_x.ax_utilities_state"]
        ...
        essential_modules["blind_x.ax_utilities"].AXUtilities = ax_utilities_class_mock
    ...
    def test_get_current_value(
        ...
        from blind_x.ax_value import AXValue
    ...
    def test_get_current_value_text(  # pylint: disable=too-many-locals
        ...
        essential_modules["blind_x.ax_object"].AXObject.supports_value = test_context.Mock(
    ...
    def test_get_value_as_percent(
        ...
        essential_modules["blind_x.ax_object"].AXObject.supports_value = supports_value_mock
        essential_modules[
            "blind_x.ax_utilities_state"
