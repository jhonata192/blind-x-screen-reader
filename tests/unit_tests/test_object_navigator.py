...
class TestObjectNavigator:
    ...
    def _setup_dependencies(self, test_context: OrcaTestContext) -> dict[str, MagicMock]:
        ...
        if "blind_x.object_navigator" in sys.modules:
            object_navigator_module = sys.modules["blind_x.object_navigator"]
    ...
    def test_init_creates_navigator_with_defaults(self, test_context: OrcaTestContext) -> None:
        ...
        from blind_x.object_navigator import (
            ObjectNavigator,  # pylint: disable=import-outside-toplevel
        )
    ...
    def test_setup_registers_dbus_commands(self, test_context: OrcaTestContext) -> None:
        ...
        dbus_service = essential_modules["blind_x.dbus_service"]
    ...
    def test_children_returns_list_for_object_with_children(
        ...
        ax_object = essential_modules["blind_x.ax_object"].AXObject
    ...
    def test_update_tracks_locus_of_focus(self, test_context: OrcaTestContext) -> None:
        ...
        focus_manager = essential_modules["blind_x.focus_manager"].get_manager.return_value
    ...
    def test_perform_action_calls_synthesizer(self, test_context: OrcaTestContext) -> None:
        ...
        mock_script = test_context.Mock()
        mock_obj = test_context.Mock()
        ax_event_synthesizer = essential_modules["blind_x.ax_event_synthesizer"].AXEventSynthesizer
    ...
    def test_get_navigator_returns_singleton_instance(self, test_context: OrcaTestContext) -> None:
        ...
        self._setup_dependencies(test_context)
        from blind_x.object_navigator import (
            get_navigator,  # pylint: disable=import-outside-toplevel
        )
