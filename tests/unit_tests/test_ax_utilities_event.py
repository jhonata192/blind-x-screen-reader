...
class TestAXUtilitiesEvent:
    ...
    def _setup_dependencies(self, test_context: "OrcaTestContext") -> "dict[str, MagicMock]":
        ...
        from blind_x.ax_utilities_event import AXUtilitiesEvent
        ...
        from blind_x.ax_object import AXObject
        from blind_x.ax_text import AXText
        from blind_x.ax_utilities_object import AXUtilitiesObject
        from blind_x.ax_utilities_state import AXUtilitiesState
    ...
    def test_get_text_event_reason_with_cached_reason(self, test_context):
        ...
        self._setup_dependencies(test_context)
        from blind_x.ax_utilities_event import AXUtilitiesEvent, TextEventReason
    ...
    def test_get_caret_moved_event_reason_scenarios(
        ...
        self._setup_dependencies(test_context)
        from blind_x import focus_manager, input_event_manager
        from blind_x.ax_utilities_event import AXUtilitiesEvent, TextEventReason
        from blind_x.ax_utilities_role import AXUtilitiesRole
    ...
    def test_get_text_deletion_event_reason_scenarios(self, test_context, case: dict):
        ...
        self._setup_dependencies(test_context)
        from blind_x import input_event_manager
        from blind_x.ax_object import AXObject
        from blind_x.ax_utilities_event import AXUtilitiesEvent, TextEventReason
        from blind_x.ax_utilities_role import AXUtilitiesRole
        from blind_x.ax_utilities_state import AXUtilitiesState
    ...
    def test_get_text_deletion_event_reason_selected_text_deletion(self, test_context):
        ...
        from blind_x.ax_utilities_role import AXUtilitiesRole
        from blind_x.ax_utilities_state import AXUtilitiesState
        from blind_x.ax_utilities_text import AXUtilitiesText
    ...
    def test_get_text_insertion_event_reason_typing_echoable(self, test_context):
        ...
        from blind_x import typing_echo_presenter
