...
class TestWhereAmIPresenter:
    ...
    def _setup_dependencies(self, test_context: OrcaTestContext):
        ...
        additional_modules = [
            "blind_x.flat_review_presenter",
            "blind_x.speech_presenter",
            "blind_x.spellcheck_presenter",
            "blind_x.text_attribute_manager",
            "blind_x.ax_component",
            "blind_x.ax_text",
            "blind_x.ax_utilities",
            "blind_x.braille_presenter",
            "blind_x.presentation_manager",
        ]
        essential_modules = test_context.setup_shared_dependencies(additional_modules)

        cmdnames_mock = essential_modules["blind_x.cmdnames"]
        ...
        messages_mock = essential_modules["blind_x.messages"]
        ...
        essential_modules["blind_x.input_event"].InputEvent = test_context.Mock()

        text_attr_mgr = essential_modules["blind_x.text_attribute_manager"]
        ...
        essential_modules["blind_x.speech_presenter"].get_presenter = test_context.Mock(
            return_value=speech_verbosity_instance,
        )

        ax_component_mock = essential_modules["blind_x.ax_component"]
        ...
        ax_text_mock = essential_modules["blind_x.ax_text"]
    ...
    def test_init(self, test_context: OrcaTestContext) -> None:
        ...
        dbus_mock = deps["blind_x.dbus_service"]
    ...
    def test_present_character_attributes(self, test_context: OrcaTestContext) -> None:
        ...
        deps["blind_x.ax_text"].AXText.get_text_attributes_at_offset.return_value = (
        ...
        pres_manager = deps["blind_x.presentation_manager"].get_manager()
    ...
    def test_present_size_and_position_flat_review(self, test_context: OrcaTestContext) -> None:
        ...
        deps["blind_x.flat_review_presenter"].get_presenter.return_value = flat_review_presenter_mock
        ...
        rect.x = 50
        rect.y = 75
        deps["blind_x.ax_component"].AXComponent.get_rect.return_value = rect
        deps["blind_x.ax_utilities"].AXUtilities.is_empty_rect.return_value = False
        pres_manager = deps["blind_x.presentation_manager"].get_manager()
    ...
    def test_present_size_and_position_empty_rect(self, test_context: OrcaTestContext) -> None:
        ...
        deps["blind_x.ax_utilities"].AXUtilities.is_empty_rect.return_value = True
        pres_manager = deps["blind_x.presentation_manager"].get_manager()
        pres_manager.present_message.reset_mock()
        presenter = WhereAmIPresenter()
        result = presenter.present_size_and_position(mock_script)
    ...
    def test_present_title_valid_focus(self, test_context: OrcaTestContext) -> None:
        ...
        deps["blind_x.ax_object"].AXObject.is_dead.return_value = False
    ...
    def test_present_title_dead_focus(self, test_context: OrcaTestContext) -> None:
        ...
        deps["blind_x.ax_object"].AXObject.is_dead.side_effect = [True, False]
    ...
    def test_present_title_no_valid_object(self, test_context: OrcaTestContext) -> None:
        ...
        deps["blind_x.focus_manager"].get_manager.return_value.get_locus_of_focus.return_value = None
        deps["blind_x.focus_manager"].get_manager.return_value.get_active_window.return_value = None

        deps["blind_x.ax_object"].AXObject.is_dead.return_value = True
        pres_manager = deps["blind_x.presentation_manager"].get_manager()
        pres_manager.present_message.reset_mock()
        mock_script = test_context.Mock()
        presenter = WhereAmIPresenter()
    ...
    def test_present_default_button_scenarios(
        ...
        if has_button:
            ...
            deps["blind_x.ax_utilities"].AXUtilities.get_default_button.return_value = button
            deps["blind_x.ax_utilities"].AXUtilities.is_sensitive.return_value = is_sensitive
            deps["blind_x.ax_object"].AXObject.get_name.return_value = button_name
        else:
            deps["blind_x.ax_utilities"].AXUtilities.get_default_button.return_value = None
    ...
    def test_present_status_bar_with_info(self, test_context: OrcaTestContext) -> None:
        ...
        deps["blind_x.ax_utilities"].AXUtilities.get_status_bar.return_value = statusbar
        deps["blind_x.ax_utilities"].AXUtilities.get_info_bar.return_value = infobar
        deps["blind_x.ax_utilities"].AXUtilities.is_showing.return_value = True
        deps["blind_x.ax_utilities"].AXUtilities.is_visible.return_value = True
        presenter = WhereAmIPresenter()
    ...
    def test_present_status_bar_no_status_bar(self, test_context: OrcaTestContext) -> None:
        ...
        mock_script.utilities.frame_and_dialog.return_value = (frame, None)
        mock_script.present_object = test_context.Mock()
        deps["blind_x.ax_utilities"].AXUtilities.get_status_bar.return_value = None
        deps["blind_x.ax_utilities"].AXUtilities.get_info_bar.return_value = None
        pres_manager = deps["blind_x.presentation_manager"].get_manager()
        pres_manager.present_message.reset_mock()
        presenter = WhereAmIPresenter()
        result = presenter.present_status_bar(mock_script)
    ...
    def test_get_all_selected_text_spreadsheet_cell(self, test_context: OrcaTestContext) -> None:
        ...
        mock_script = test_context.Mock()
        deps["blind_x.ax_utilities"].AXUtilities.is_spreadsheet_cell.return_value = True

        deps["blind_x.ax_utilities"].AXUtilities.get_selected_text.return_value = (
            "cell text",
            0,
            9,
        )
    ...
    def test_get_all_selected_text_with_adjacent(self, test_context: OrcaTestContext) -> None:
        ...
        mock_script = test_context.Mock()
        deps["blind_x.ax_utilities"].AXUtilities.is_spreadsheet_cell.return_value = False
        ...
        deps["blind_x.ax_utilities"].AXUtilities.get_selected_text.side_effect = [
    ...
    def test_present_selected_text_with_text(self, test_context: OrcaTestContext) -> None:
        ...
        manager = deps["blind_x.speech_presenter"].get_presenter.return_value
    ...
    def test_present_selection_spreadsheet_handling(self, test_context: OrcaTestContext) -> None:
        ...
        deps["blind_x.ax_utilities"].AXUtilities.find_ancestor.return_value = spreadsheet
        mock_script = test_context.Mock()
    ...
    def test_present_selection_container_selection(self, test_context: OrcaTestContext) -> None:
        ...
        deps["blind_x.ax_utilities"].AXUtilities.find_ancestor.return_value = None
        deps["blind_x.ax_object"].AXObject.get_name.side_effect = ["Item 1", "Item 2"]

        container = test_context.Mock()
        selected_items = [test_context.Mock(), test_context.Mock()]
        mock_script = test_context.Mock()
        deps["blind_x.ax_utilities"].AXUtilities.get_selection_container.return_value = container
        deps["blind_x.ax_utilities"].AXUtilities.selected_child_count.return_value = 2
        deps["blind_x.ax_utilities"].AXUtilities.selectable_child_count.return_value = 5
        deps["blind_x.ax_utilities"].AXUtilities.selected_children.return_value = selected_items
        pres_manager = deps["blind_x.presentation_manager"].get_manager()
        pres_manager.present_message.reset_mock()
        pres_manager.speak_message.reset_mock()
        presenter = WhereAmIPresenter()
    ...
    def test_present_selection_no_container(self, test_context: OrcaTestContext) -> None:
        ...
        deps["blind_x.ax_utilities"].AXUtilities.find_ancestor.return_value = None
        mock_script = test_context.Mock()
        deps["blind_x.ax_utilities"].AXUtilities.get_selection_container.return_value = None
        presenter = WhereAmIPresenter()
    ...
    def test_do_where_am_i_basic(self, test_context: OrcaTestContext) -> None:
        ...
        deps["blind_x.ax_utilities"].AXUtilities.is_focused.return_value = True
        deps["blind_x.ax_utilities"].AXUtilities.is_table_cell_or_header.return_value = False
        deps["blind_x.ax_utilities"].AXUtilities.is_list_item.return_value = False
        deps["blind_x.ax_utilities"].AXUtilities.is_layout_only.return_value = False
        mock_script = test_context.Mock()
    ...
    def test_do_where_am_i_detailed(self, test_context: OrcaTestContext) -> None:
        ...
        from blind_x.generator import WhereAmI
    ...
    def test_do_where_am_i_with_spellcheck(self, test_context: OrcaTestContext) -> None:
        ...
        deps["blind_x.spellcheck_presenter"].get_presenter.return_value = spellcheck_mock
    ...
    def test_get_presenter(self, test_context: OrcaTestContext) -> None:
        ...
        self._setup_dependencies(test_context)
        from blind_x.where_am_i_presenter import get_presenter
