...
class TestAXObject:
    ...
    def test_get_toolkit_name(
        ...
        if case["expects_error"]:
            ...
            test_context.patch_object(
                debug,
                "print_tokens",
                new=essential_modules["blind_x.debug"].print_tokens,
            )
        else:
            test_context.patch_object(
                Atspi.Accessible,
    ...
    def test_clear_all_dictionaries(self, test_context: OrcaTestContext, case: dict) -> None:
        ...
        essential_modules["blind_x.debug"].print_message.assert_called_with(
    ...
    def test_supports_collection(
        ...
        if case["expects_debug"]:
            ...
            if case["scenario"] == "get_application_error":
                calls = essential_modules["blind_x.debug"].print_message.call_args_list
                assert len(calls) == 1
                call_args = calls[0][0]
                assert call_args[0] == essential_modules["blind_x.debug"].LEVEL_INFO
    ...
    def test_handle_error(self, test_context, case: dict) -> None:
        ...
        essential_modules["blind_x.debug"].print_message.assert_called_once()
        call_args = essential_modules["blind_x.debug"].print_message.call_args[0]
    ...
    def test_grab_focus_basic_success(self, test_context: OrcaTestContext) -> None:
        ...
        test_context.patch("blind_x.ax_object.Atspi.Component.grab_focus", new=mock_grab_focus)
        result = AXObject.grab_focus(mock_accessible)
        assert result is True
    ...
    def test_has_document_spreadsheet_import_path(self, test_context: OrcaTestContext) -> None:
        ...
        sys.modules["blind_x.ax_collection"] = mock_ax_collection
    ...
    def test_get_image_size_various_conditions(
        ...
        if case["image_support"]:
            ...
            test_context.patch("blind_x.ax_object.Atspi.Image", new=atspi_image_mock)
    ...
    def test_get_help_text_various_conditions(
        ...
        if case["valid_obj"]:
            ...
            test_context.patch("blind_x.ax_object.Atspi.Accessible", new=atspi_accessible_mock)
    ...
    def test_iter_children(  # pylint: disable=too-many-locals
        ...
        test_context.patch("blind_x.ax_object.debug", new=debug_mock)
