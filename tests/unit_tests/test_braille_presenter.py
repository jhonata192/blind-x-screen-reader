...
class TestBraillePresenter:
    ...
    def _setup_dependencies(self, test_context: OrcaTestContext) -> dict[str, MagicMock]:
        ...
        additional_modules = ["blind_x.braille", "blind_x.braille_monitor", "blind_x.orca_platform"]
        ...
        test_context.patch(
            "blind_x.braille_presenter.BraillePresenter._get_table_files",
            return_value=[
                "en-us-g1.ctb",
                "en-us-g2.ctb",
                "en-us-comp8.ctb",
    ...
    def test_get_braille_is_enabled(self, test_context: OrcaTestContext):
        ...
        from blind_x.braille_presenter import get_presenter
    ...
    def test_update_monitor_creates_when_enabled(self, test_context: OrcaTestContext):
        ...
        essential_modules = self._setup_dependencies(test_context)
        braille_monitor_mock = essential_modules["blind_x.braille_monitor"]
        from blind_x.braille_presenter import get_presenter
    ...
    def test_shutdown_braille_does_not_destroy_monitor(self, test_context: OrcaTestContext):
        ...
        assert presenter._monitor is mock_monitor
        essential_modules["blind_x.braille"].shutdown.assert_called_once()
...
class TestBraillePreferencesGridUI:
    ...
    def test_braille_verbosity_grid_creates_widgets(self, test_context: OrcaTestContext) -> None:
        ...
        self._setup_dependencies(test_context)
        from blind_x.braille_presenter import (
            BraillePresenter,
    ...
    def test_braille_preferences_grid_creates_multi_page_stack(
        ...
        self._setup_dependencies(test_context)
        from blind_x.braille_presenter import BraillePreferencesGrid, BraillePresenter
