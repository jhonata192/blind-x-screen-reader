...
class TestAXTable:
    ...
    def _setup_dependencies(self, test_context: OrcaTestContext) -> dict[str, MagicMock]:
        ...
        ax_utilities_object_mock = essential_modules["blind_x.ax_utilities_object"]
    ...
    def _setup_layout_table_mocks(
        ...
        from blind_x.ax_object import AXObject
        from blind_x.ax_table import AXTable
        from blind_x.ax_utilities_table import AXUtilitiesTable
    ...
    def test_clear_cache_now(self, test_context: OrcaTestContext) -> None:
        ...
        test_context.patch("blind_x.ax_table.AXTable._clear_all_dictionaries", new=mock_clear)
    ...
    def test_get_presentable_sort_order_from_header(
        ...
        mock_cell = test_context.Mock(spec=Atspi.Accessible)
        self._setup_dependencies(test_context)
        from blind_x import object_properties
        from blind_x.ax_object import AXObject
        from blind_x.ax_utilities_role import AXUtilitiesRole
        from blind_x.ax_utilities_table import AXUtilitiesTable
