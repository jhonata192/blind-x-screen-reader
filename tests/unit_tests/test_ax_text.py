...
class TestAXTextAttribute:
    ...
    def _setup_dependencies(self, test_context: OrcaTestContext) -> dict[str, MagicMock]:
        ...
        colornames_mock = essential_modules["blind_x.colornames"]
        ...
        text_attribute_names_mock = essential_modules["blind_x.text_attribute_names"]
        ...
        ax_utilities_role_mock = essential_modules["blind_x.ax_utilities_role"]
        role_class_mock = test_context.Mock()
        ax_utilities_role_mock.AXUtilitiesRole = role_class_mock

        ax_utilities_state_mock = essential_modules["blind_x.ax_utilities_state"]
    ...
    def test_from_string_with_valid_attribute(self, test_context: OrcaTestContext) -> None:
        ...
        from blind_x.ax_text import AXTextAttribute
...
class TestAXText:
    ...
    def test_get_caret_offset(
        ...
        essential_modules["blind_x.debug"].print_tokens = test_context.Mock()
        ...
        assert result == case["expected_result"]
        getattr(essential_modules["blind_x.debug"], case["expected_debug_method"]).assert_called()
    ...
    def test_get_at_point_methods_scenarios(  # pylint: disable=too-many-locals
        ...
        if case["method_type"] == "offset":
            ...
            if case["debug_method"]:
                getattr(essential_modules["blind_x.debug"], case["debug_method"]).assert_called()
        else:
            test_context.patch_object(
                AXText,
                "get_offset_at_point",
    ...
    def test_set_selected_text_with_existing_selection(self, test_context: OrcaTestContext) -> None:
        ...
        essential_modules: dict[str, MagicMock] = self._setup_dependencies(test_context)
        essential_modules["blind_x.debug"].debugLevel = 0
