...
class TestSystemInformationPresenter:
    ...
    def _setup_dependencies(self, test_context: OrcaTestContext) -> dict[str, MagicMock]:
        ...
        keynames_mock = essential_modules["blind_x.keynames"]
    ...
    def test_init(self, test_context: OrcaTestContext) -> None:
        ...
        test_context.patch(
            "blind_x.system_information_presenter.dbus_service.get_remote_controller",
            return_value=mock_controller,
        )

        mock_bindings_instance = test_context.Mock()
        test_context.patch(
            "blind_x.system_information_presenter.keybindings.KeyBindings",
            return_value=mock_bindings_instance,
        )
        from blind_x import command_manager
        from blind_x.system_information_presenter import SystemInformationPresenter
    ...
    def test_present_time_and_date(
        ...
        if has_event and debugging_enabled:
            essential_modules["blind_x.debug"].print_tokens.assert_called_once()
    ...
    def test_present_battery_status(
        ...
        if (
            ...
            and "blind_x.system_information_presenter" in __import__("sys").modules
        ):
            del __import__("sys").modules["blind_x.system_information_presenter"]
        ...
        if psutil_available:
            test_context.patch("blind_x.system_information_presenter._PSUTIL_AVAILABLE", new=True)
            if has_battery:
    ...
    def test_present_cpu_and_memory_usage(
        ...
        if not psutil_available:
            if "blind_x.system_information_presenter" in __import__("sys").modules:
                del __import__("sys").modules["blind_x.system_information_presenter"]
            import sys
        ...
        if psutil_available:
            ...
            if memory_size == "gb":
                essential_modules["blind_x.messages"].memory_usage_gb.assert_called_once()
            elif memory_size == "mb":
                essential_modules["blind_x.messages"].memory_usage_mb.assert_called_once()
    ...
    def test_module_level_psutil_detection(self, test_context: OrcaTestContext) -> None:
        ...
        if "blind_x.system_information_presenter" in sys.modules:
            del sys.modules["blind_x.system_information_presenter"]
        self._setup_dependencies(test_context)
        from blind_x.system_information_presenter import _PSUTIL_AVAILABLE
        ...
        import blind_x.system_information_presenter as presenter_module
    ...
    def test_get_date_format(
        ...
        test_context.patch(
            "blind_x.system_information_presenter.dbus_service.getter",
    ...
    def test_set_date_format(
        ...
        test_context.patch(
            "blind_x.system_information_presenter.dbus_service.setter",
            new=lambda func: func,
        )
        ...
        if expected_success:
            ...
            debug_mock = essential_modules["blind_x.debug"].print_message
            assert any(
