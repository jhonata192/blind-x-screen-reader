...
class TestSleepModeManager:
    ...
    def _setup_dependencies(self, test_context: OrcaTestContext) -> dict[str, MagicMock]:
        ...
        essential_modules = test_context.setup_shared_dependencies(
            ["blind_x.braille_presenter", "blind_x.presentation_manager", "blind_x.ax_utilities"],
        )
    ...
    def test_init(self, test_context: OrcaTestContext) -> None:
        ...
        from blind_x.sleep_mode_manager import SleepModeManager
        ...
        assert essential_modules["blind_x.dbus_service"] is not None
    ...
    def test_toggle_sleep_mode_with_script_and_app(  # pylint: disable=too-many-branches
        ...
        test_context.patch(
            "blind_x.sleep_mode_manager.script_manager.get_manager",
