...
class TestScriptManager:
    ...
    def _setup_dependencies(self, test_context: OrcaTestContext) -> dict[str, MagicMock]:
        ...
        modules_to_clean = ["blind_x.script_manager"]
        ...
        additional_modules = [
            ...
            "blind_x.scripts",
            "blind_x.scripts.apps",
            "blind_x.scripts.default",
            "blind_x.scripts.sleepmode",
            "blind_x.scripts.toolkits",
            "blind_x.sleep_mode_manager",
            "blind_x.speech_manager",
        ]
        essential_modules = test_context.setup_shared_dependencies(additional_modules)

        if "blind_x.script_manager" in essential_modules:
            del essential_modules["blind_x.script_manager"]
        if "blind_x.script_manager" in sys.modules:
            del sys.modules["blind_x.script_manager"]
        ...
        speech_verbosity_mock = essential_modules["blind_x.speech_manager"]
        ...
        command_manager_mock = essential_modules["blind_x.command_manager"]
        ...
        scripts_mock = essential_modules["blind_x.scripts"]
        apps_mock = essential_modules["blind_x.scripts.apps"]
        toolkits_mock = essential_modules["blind_x.scripts.toolkits"]
        default_mock = essential_modules["blind_x.scripts.default"]
        sleepmode_mock = essential_modules["blind_x.scripts.sleepmode"]
        ...
        sleep_mode_manager_mock = essential_modules["blind_x.sleep_mode_manager"]
    ...
    def test_init(self, test_context: OrcaTestContext) -> None:
        ...
        from blind_x.script_manager import ScriptManager
    ...
    def test_activate(self, test_context: OrcaTestContext, case: dict) -> None:
        ...
        if case["expects_script_creation"]:
            ...
            test_context.patch("blind_x.script_manager.default.Script", new=mock_default_script)
    ...
    def test_get_module_name_scenarios(self, test_context, case: dict) -> None:
        ...
        if case["use_null_app"]:
            ...
            test_context.patch("blind_x.script_manager.AXObject", new=mock_ax_object)
    ...
    def test_script_for_role(self, test_context, case: dict) -> None:
        ...
        test_context.patch("blind_x.script_manager.AXUtilities", new=mock_ax_utilities)
    ...
    def test_create_script(self, test_context: OrcaTestContext, case: dict) -> None:
        ...
        test_context.patch(
            "blind_x.script_manager.AXUtilities.get_application_toolkit_name",
            return_value=None,
        )
    ...
    def test_get_or_create_sleep_mode_script(self, test_context: OrcaTestContext) -> None:
        ...
        test_context.patch("blind_x.script_manager.sleepmode.Script", new=mock_sleepmode_script)
    ...
    def test_set_active_script(self, test_context: OrcaTestContext) -> None:
        ...
        test_context.patch(
            "blind_x.script_manager.speech_manager.get_manager",
    ...
    def test_reclaim_scripts(self, test_context: OrcaTestContext, case: dict) -> None:
        ...
        desktop_patch = "blind_x.script_manager.AXUtilities.is_application_in_desktop"
    ...
    def test_get_manager(self, test_context: OrcaTestContext) -> None:
        ...
        self._setup_dependencies(test_context)
        from blind_x import script_manager
