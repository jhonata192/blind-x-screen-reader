...
@pytest.mark.unit
class TestBlindXModifierManager:
    """Test BlindXModifierManager class methods."""

    def _setup_dependencies(self, test_context: OrcaTestContext) -> dict[str, MagicMock]:
        """Returns dependencies for orca_modifier_manager module testing."""

        additional_modules = ["blind_x.ax_device_manager", "blind_x.input_event_manager", "gi.repository"]
        ...
        ax_device_manager_mock = essential_modules["blind_x.ax_device_manager"]
    ...
    def test_init(self, test_context: OrcaTestContext) -> None:
        """Test BlindXModifierManager.__init__."""

        self._setup_dependencies(test_context)

        mock_gdk = test_context.Mock()
        test_context.patch("blind_x.orca_modifier_manager.Gdk", new=mock_gdk)
        ...
        manager = orca_modifier_manager.BlindXModifierManager()
    ...
    def test_init_no_display(self, test_context: OrcaTestContext) -> None:
        """Test BlindXModifierManager.__init__ with no display available."""
        ...
        essential_modules["blind_x.debug"].reset_mock()
        manager = orca_modifier_manager.BlindXModifierManager()
    ...
    def test_on_device_changed(
        ...
        """Test BlindXModifierManager._on_device_changed."""
        ...
        test_context.patch_object(manager, "refresh_blind_x_modifiers", new=mock_refresh)
        test_context.patch("blind_x.orca_modifier_manager.Gdk.InputSource.KEYBOARD", new=4)
        ...
        [
            {
                "id": "insert_grabbed",
                "modifier": "Insert",
                "blind_x_modifier_keys": ["Insert", "KP_Insert"],
                "is_grabbed": True,
            ...
            },
            {
                ...
                "modifier": "Caps_Lock",
                "blind_x_modifier_keys": ["Caps_Lock"],
                "is_grabbed": False,
            ...
            },
            {
                ...
                "modifier": "Shift_Lock",
                "blind_x_modifier_keys": ["Shift_Lock"],
                "is_grabbed": False,
                "modifiers_are_set": True,
                "expected_result": True,
            },
    ...
    def test_is_orca_modifier(
        ...
        """Test BlindXModifierManager.is_blind_x_modifier."""
        ...
        manager._modifier_keys_override = case["blind_x_modifier_keys"]
        result = manager.is_blind_x_modifier(case["modifier"])
    ...
    def test_pressed_state_operations(self, test_context, case: dict) -> None:
        """Test BlindXModifierManager get_pressed_state and set_pressed_state."""
    ...
    def test_is_modifier_grabbed(
        ...
        """Test BlindXModifierManager.is_modifier_grabbed."""
    ...
    @pytest.mark.parametrize(
        "blind_x_modifier_keys, expected_calls",
        [
    ...
    def test_add_grabs_for_orca_modifiers(
        self,
        test_context,
        blind_x_modifier_keys,
        expected_calls,
    ) -> None:
        """Test BlindXModifierManager.add_grabs_for_blind_x_modifiers."""

        self._setup_dependencies(test_context)

        manager = orca_modifier_manager.BlindXModifierManager()
        manager._modifier_keys_override = blind_x_modifier_keys

        mock_add_grab = test_context.Mock()
        test_context.patch_object(manager, "add_modifier_grab", new=mock_add_grab)
        manager.add_grabs_for_blind_x_modifiers()
    ...
    def test_remove_grabs_for_orca_modifiers(
        ...
        """Test BlindXModifierManager.remove_grabs_for_blind_x_modifiers."""
        ...
        manager.remove_grabs_for_blind_x_modifiers()
        calls = [call(modifier) for modifier in expected_calls]
    ...
    def test_add_modifier_grab(
        ...
        """Test BlindXModifierManager.add_modifier_grab with various scenarios."""
        ...
        if scenario != "existing":
            ...
            test_context.patch(
                "blind_x.orca_modifier_manager.keybindings.get_keycodes",
            ...
            test_context.patch(
                "blind_x.orca_modifier_manager.ax_device_manager.get_manager",
        ...
        if expects_keycodes_call:
            ...
            essential_modules["blind_x.keybindings"].get_keycodes.assert_not_called()
    ...
    def test_remove_modifier_grab(
        ...
        """Test BlindXModifierManager.remove_modifier_grab with grabbed and non-grabbed modifiers."""
    ...
    def test_toggle_modifier(
        ...
        """Test BlindXModifierManager.toggle_modifier."""
    ...
    def test_toggle_modifier_grab(
        ...
        """Test BlindXModifierManager._toggle_modifier_grab with pressed and released keys."""
        self._setup_dependencies(test_context)
        ...
        test_context.patch("blind_x.orca_modifier_manager.GLib.timeout_add", new=mock_timeout)
        test_context.patch(
            "blind_x.orca_modifier_manager.Atspi.generate_keyboard_event",
    ...
    def test_toggle_modifier_lock(
        ...
        """Test BlindXModifierManager._toggle_modifier_lock."""

        self._setup_dependencies(test_context)

        test_context.patch("blind_x.orca_modifier_manager.Atspi.ModifierType.SHIFTLOCK", new=1)
        test_context.patch("blind_x.orca_modifier_manager.Atspi.ModifierType.SHIFT", new=0)
        manager = orca_modifier_manager.BlindXModifierManager()
        mock_keyboard_event = test_context.Mock()
        mock_keyboard_event.keyval_name = keyval_name
        mock_keyboard_event.hw_code = 110
    ...
    def test_refresh_orca_modifiers(self, test_context: OrcaTestContext) -> None:
        """Test BlindXModifierManager.refresh_blind_x_modifiers."""
        ...
        test_context.patch("blind_x.orca_modifier_manager.subprocess.Popen", new=mock_popen)
        ...
        test_context.patch_object(manager, "_create_blind_x_xmodmap", new=mock_create)
        manager.refresh_blind_x_modifiers("test reason")
    ...
    def test_create_orca_xmodmap(
        ...
        """Test BlindXModifierManager._create_blind_x_xmodmap."""
        ...
        blind_x_modifier_keys: list[str] = []
        if caps_lock_orca:
            blind_x_modifier_keys.append("Caps_Lock")
        if shift_lock_orca:
            blind_x_modifier_keys.append("Shift_Lock")
        manager._modifier_keys_override = blind_x_modifier_keys
        mock_set_caps = test_context.Mock()
        test_context.patch_object(manager, "set_caps_lock_as_blind_x_modifier", new=mock_set_caps)
        manager._create_blind_x_xmodmap()
    ...
    def test_unset_orca_modifiers(
        ...
        """Test BlindXModifierManager.unset_blind_x_modifiers with and without xmodmap."""
        essential_modules: dict[str, MagicMock] = self._setup_dependencies(test_context)
        ...
        manager.unset_blind_x_modifiers("test reason" if has_xmodmap else "")
    ...
    def test_set_caps_lock_as_orca_modifier(
        ...
        """Test BlindXModifierManager.set_caps_lock_as_blind_x_modifier with various scenarios."""
        essential_modules: dict[str, MagicMock] = self._setup_dependencies(test_context)
        ...
        manager.set_caps_lock_as_blind_x_modifier(enable)
    ...
    def test_get_manager(
        ...
        assert isinstance(manager1, orca_modifier_manager.BlindXModifierManager)
