...
class TestCaretNavigator:
    ...
    def test_character_navigation(
        ...
        from blind_x.caret_navigator import (
            CaretNavigator,  # pylint: disable=import-outside-toplevel
        )
    ...
    def test_navigator_initialization(self, test_context: OrcaTestContext) -> None:
        ...
        from blind_x.caret_navigator import CaretNavigator
    ...
    def test_line_navigation(
        ...
        if in_say_all:
            from blind_x import say_all_presenter  # pylint: disable=import-outside-toplevel
