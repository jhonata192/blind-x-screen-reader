...
from blind_x.ax_selection import AXSelection
from blind_x.ax_text import AXText
from blind_x.ax_utilities import AXUtilities
from blind_x.ax_utilities_event import TextEventReason
from blind_x.ax_utilities_text import TextUnit
from blind_x.command import BrailleCommand, KeyboardCommand
...
class Script(script.Script):
    ...
    def show_app_preferences_gui(
        ...
        ui = blind_x_gui_prefs.BlindXSetupGUI(current_script)
        ui.show_gui()
        return True
    ...
    def show_preferences_gui(
        ...
        ui = blind_x_gui_prefs.BlindXSetupGUI(default_script)
        ui.show_gui()
        return True
