...
@gsettings_registry.get_registry().gsettings_enum(
    "org.gnome.BlindX.MathCopyFormat",
...
@gsettings_registry.get_registry().gsettings_enum(
    "org.gnome.BlindX.MathBrailleNavHighlight",
...
@gsettings_registry.get_registry().gsettings_schema(
    "org.gnome.BlindX.MathPresentation", name="math-presentation"
)
class MathPresenter(Extension):
    ...
    @gsettings_registry.get_registry().gsetting(
        key=KEY_COPY_FORMAT,
        schema="math-presentation",
        genum="org.gnome.BlindX.MathCopyFormat",
        default="mathml",
    ...
    @gsettings_registry.get_registry().gsetting(
        key=KEY_NAV_MODE,
        schema="math-presentation",
        genum="org.gnome.BlindX.MathNavMode",
        default="enhanced",
    ...
    @gsettings_registry.get_registry().gsetting(
        ...
        schema="math-presentation",
        genum="org.gnome.BlindX.MathBrailleNavHighlight",
        default="off",
