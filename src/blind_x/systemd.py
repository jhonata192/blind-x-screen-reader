...
"""Blind-X's integration with the systemd service manager"""
...
class Systemd:
    ...
    def notify_ready(self) -> None:
        """Tell systemd that Blind-X has finished starting up / reloading"""
        self._notify(b"READY=1")

    def notify_reloading(self) -> None:
        """Tell systemd that Blind-X has started reloading"""
    ...
    def notify_stopping(self) -> None:
        """Tell systemd that Blind-X is shutting down"""
    ...
    def notify_alive(self, reason: str = "") -> None:
        """Tell systemd that Blind-X is still alive"""
    ...
    def start_watchdog(self) -> None:
        ...
        # systemd will restart Blind-X. So, we want to ping more quickly than
    ...
    def is_systemd_managed(self) -> bool:
        """Returns whether or not Blind-X is being managed by systemd"""
