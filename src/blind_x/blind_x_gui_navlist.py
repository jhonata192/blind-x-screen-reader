...
"""Displays a GUI for Blind-X navigation list dialogs"""
...
class BlindXNavListGUI:
    """A GUI for displaying navigation lists in Blind-X."""
...
def show_ui(
    ...
    gui = BlindXNavListGUI(title, column_headers, rows, selected_row)
    gui.show_gui()
