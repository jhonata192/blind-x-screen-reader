...
@gsettings_registry.get_registry().gsettings_enum(
    "org.gnome.BlindX.FindResultsVerbosity",
...
@gsettings_registry.get_registry().gsettings_schema("org.gnome.BlindX.Document", name="document")
class DocumentPresenter(Extension):
    ...
    @gsettings_registry.get_registry().gsetting(
        ...
        schema="document",
        genum="org.gnome.BlindX.FindResultsVerbosity",
        default="all",
