...
class KeyboardEvent(InputEvent):
    ...
    def is_alt_control_or_blind_x_modified(self) -> bool:
        """Return True if this key is Alt, Control, or Blind-X modified."""
    ...
    def should_obscure(self) -> bool:
        ...
        return not self.is_alt_control_or_blind_x_modified()
    ...
    def is_modifier_key(self) -> bool:
        ...
        return self.id in self._MODIFIER_KEYS or self.is_blind_x_modifier()
    ...
    def is_blind_x_modifier(self) -> bool:
