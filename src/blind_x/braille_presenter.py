...
@gsettings_registry.get_registry().gsettings_enum(
    "org.gnome.BlindX.VerbosityLevel",
...
@gsettings_registry.get_registry().gsettings_enum(
    "org.gnome.BlindX.BrailleIndicator",
...
@gsettings_registry.get_registry().gsettings_enum(
    "org.gnome.BlindX.ProgressBarVerbosity",
...
@gsettings_registry.get_registry().gsettings_schema("org.gnome.BlindX.Braille", name="braille")
class BraillePresenter(Extension):
    ...
    @gsettings_registry.get_registry().gsetting(
        ...
        schema="braille",
        genum="org.gnome.BlindX.ProgressBarVerbosity",
        default="application",
    ...
    def _get_selector_indicator_as_int(self) -> int:
        ...
        nick = gsettings_registry.get_registry().layered_lookup(
            ...
            self.KEY_SELECTOR_INDICATOR,
            "",
            genum="org.gnome.BlindX.BrailleIndicator",
            default="dots78",
        )
