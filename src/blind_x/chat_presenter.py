...
@gsettings_registry.get_registry().gsettings_enum(
    "org.gnome.BlindX.ChatMessageVerbosity",
...
@gsettings_registry.get_registry().gsettings_schema("org.gnome.BlindX.Chat", name="chat")
class ChatPresenter(Extension):
    ...
    @gsettings_registry.get_registry().gsetting(
        ...
        schema="chat",
        genum="org.gnome.BlindX.ChatMessageVerbosity",
        default="all",
