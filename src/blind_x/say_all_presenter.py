...
@gsettings_registry.get_registry().gsettings_schema("org.gnome.BlindX.SayAll", name="say-all")
class SayAllPresenter(Extension):
    ...
    @gsettings_registry.get_registry().gsetting(
        key=KEY_STYLE,
        schema="say-all",
        genum="org.gnome.BlindX.SayAllStyle",
        default="sentence",
    ...
    @gsettings_registry.get_registry().gsetting(
        ...
        schema="say-all",
        genum="org.gnome.BlindX.TextAttributeChangeMode",
        default="off",
