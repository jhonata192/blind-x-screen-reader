...
["Where Am I?" command](https://github.com/jhonata192/blind-x-screen-reader/blob/main/help/C/commands_where_am_i.page)
...
role is a [user-configurable option](https://github.com/jhonata192/blind-x-screen-reader/blob/main/help/C/preferences_speech.page)
which can be set on a [per-application basis](https://github.com/jhonata192/blind-x-screen-reader/blob/main/help/C/preferences_introduction.page)
...
is still pending. See [issue #514](https://github.com/jhonata192/blind-x-screen-reader/issues/514).
